    ...
    public function store(Request $request)
    {
        ...
        if (!empty($data['image']) and !empty($data['video'])) {
            return response()->json([
                'code' => 422,
                'errors' => [
                    'image' => ['Anda hanya dapat mengisi salah satu bidang gambar atau video. Hindari mengisi keduanya.'],
                    'video' => ['Anda hanya dapat mengisi salah satu bidang gambar atau video. Hindari mengisi keduanya.'],
                ]
            ], 422);
        }
        ...
        if ($data['type'] == QuizzesQuestion::$multiple and !empty($data['answers'])) {
            ...
            if (!$hasCorrect) {
                return response([
                    'code' => 422,
                    'errors' => [
                        'current_answer' => ['Silakan pilih jawaban yang benar']
                    ],
                ], 422);
            }
        }
