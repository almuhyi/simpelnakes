    ...
    public function update(Request $request)
    {
        ...
        if (!empty($user)) {
            ...
            $toastData = [
                ...
                'msg' => 'Informasi Anda berhasil diperbarui',
                'status' => 'success'
            ];
    ...
    public function deleteAccount(Request $request)
    {
        ...
        if (!empty($user)) {
            ...
            return response()->json([
                'code' => 200,
                'title' => 'Permintaan berhasil',
                'text' => 'Permintaan Anda telah didaftarkan, akun Anda akan dihapus setelah dikonfirmasi oleh admin / staf.',
                'dont_reload' => true
            ]);
        }
