...
class WebinarController extends Controller
{
    public function index(Request $request)
    {
        ...
        $data['pageTitle'] = 'Daftar pelatihan';
    ...
    public function invitations(Request $request)
    {
        ...
        $data = $this->makeMyClassAndInvitationsData($query, $user, $request);
        $data['pageTitle'] = 'Pelatihan yang diundang';
    ...
    public function organizationClasses(Request $request)
    {
        ...
        if (!empty($user->organ_id)) {
            ...
            $data = [
                'pageTitle' => 'Pelatihan organisasi',
                'webinars' => $webinars,
            ];
    ...
    public function edit(Request $request, $id, $step = 1)
    {
        ...
        $data = [
            'pageTitle' => 'Pelatihan baru - Langkah' . ' ' . $step,
            'currentStep' => $step,
            'isOrganization' => $isOrganization,
            'userLanguages' => getUserLanguagesLists(),
        ...
        $data['pageTitle'] = 'Edit' . ' ' . $webinar->title;
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($webinarRulesRequired) {
            ...
            return redirect($url)->withErrors(['rules' => 'Harap setujui' . ' ' . 'rules' . ' ' . 'dan kolom pesan wajib diisi']);
        }
    ...
    public function exportStudentsList($id)
    {
        ...
        if (!empty($webinar)) {
            ...
            if (!empty($sales) and !$sales->isEmpty()) {
                ...
                return Excel::download($export, 'Daftar peserta' . '.xlsx');
            }

            $toastData = [
                'title' => 'Permintaan gagal',
                'msg' => 'Tidak ada peserta yang terdaftar pada pelatihan ini sehingga daftar tidak dapat diekspor.',
                'status' => 'error'
            ];
    ...
    public function purchases(Request $request)
    {
        ...
        $data = [
            'pageTitle' => 'Daftar pelatihan yang dibeli',
            'sales' => $sales,
