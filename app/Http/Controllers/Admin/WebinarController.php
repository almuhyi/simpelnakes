...
class WebinarController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $this->validate($request, [
            'type' => 'required|in:webinar,pelatihan,teks',
        ...
        if (!empty($data['teacher_id'])) {
            ...
            if (empty($teacher) or ($creator->isOrganization() and ($teacher->organ_id != $creator->id and $teacher->id != $creator->id))) {
                $toastData = [
                    ...
                    'msg' => 'Instruktur yang dipilih tidak ada atau tidak terkait dengan organisasi ini.',
                    'status' => 'error'
                ];
    ...
    public function sendNotificationToStudents(Request $request, $id)
    {
        ...
        if (!empty($webinar)) {
            ...
            $toastData = [
                ...
                'msg' => 'Notifikasi berhasil terkirim ke' . ' ' . count($webinar->sales) . ' ' . 'peserta.',
                'status' => 'success'
            ];
