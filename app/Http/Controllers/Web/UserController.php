...
class UserController extends Controller
{
    ...
    public function profile($id)
    {
        ...
        $data = [
            'pageTitle' => $user->full_name . ' ' . 'Profil',
            'user' => $user,
    ...
    public function instructors(Request $request)
    {
        ...
        $pageTitle = !empty($seoSettings['title']) ? $seoSettings['title'] : 'Instruktur';
        $pageDescription = !empty($seoSettings['description']) ? $seoSettings['description'] : 'Instruktur';
    ...
    public function organizations(Request $request)
    {
        ...
        $pageTitle = !empty($seoSettings['title']) ? $seoSettings['title'] : 'Organisasi';
        $pageDescription = !empty($seoSettings['description']) ? $seoSettings['description'] : 'Organisasi';
        ...
        if (!empty($check)) {
            if (!empty($check->user_id) and !empty($user_id) and $check->user_id != $user_id) {
                $toastData = [
                    ...
                    'msg' => 'Email ini sudah digunakan oleh pengguna lain',
                    'status' => 'error'
                ];
    ...
    public function sendMessage(Request $request, $id)
    {
        if (!empty($id)) {
            ...
            if (!empty($user) and !empty($user->email)) {
                ...
                $mail = [
                    'title' => $data['title'],
                    'message' => 'Anda mendapat pesan dari' . $data['email'] . "\n" . $data['description'],
                ];
            ...
            return response()->json([
                'code' => 403,
                'message' => 'Pesan publik pengguna dinonaktifkan!'
            ]);
        }
    }
}
