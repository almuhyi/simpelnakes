        ...
        if (auth()->check()) {
            ...
            if (!empty($bundle)) {
                if (empty($bundle->points)) {
                    $toastData = [
                        'title' => '',
                        'msg' => 'Anda tidak dapat membeli bundel ini dengan poin reward.',
                        'status' => 'error'
                    ];
                ...
                if ($availablePoints < $bundle->points) {
                    $toastData = [
                        'title' => '',
                        'msg' => 'Anda tidak memiliki cukup poin untuk membeli bundel ini...',
                        'status' => 'error'
                    ];
                    return back()->with(['toast' => $toastData]);
                }
                ...
                $toastData = [
                    'title' => '',
                    'msg' => 'Bundel berhasil dibeli dengan poin!',
                    'status' => 'success'
                ];
                return back()->with(['toast' => $toastData]);
            }
