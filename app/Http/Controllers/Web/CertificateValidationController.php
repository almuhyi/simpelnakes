...
class CertificateValidationController extends Controller
{
    public function index()
    {
        ...
        $pageTitle = !empty($getSeoMetas['title']) ? $getSeoMetas['title'] : 'Validasi sertifikat';
        $pageDescription = !empty($getSeoMetas['description']) ? $getSeoMetas['description'] : 'Validasi sertifikat';
