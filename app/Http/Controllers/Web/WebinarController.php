        ...
        if (!empty($webinar) and $this->checkCanAccessToPrivateCourse($webinar)) {
            ...
            if (!empty($file) and $file->downloadable) {
                ...
                if ($canAccess) {
                    ...
                    $toastData = [
                        'title' => 'Akses ditolak!',
                        'msg' => 'Anda tidak memiliki akses ke materi ini.',
                        'status' => 'error'
                    ];
            ...
            if (!empty($course)) {
                ...
                if (!empty($course->price) and $course->price > 0) {
                    $toastData = [
                        ...
                        'msg' => 'Pelatihan ini tidak gratis.',
                        'status' => 'error'
                    ];
                    return back()->with(['toast' => $toastData]);
                }
                ...
                $toastData = [
                    'title' => '',
                    'msg' => 'Anda berhasil mendaftar di pelatihan.',
                    'status' => 'success'
                ];
                return back()->with(['toast' => $toastData]);
            }
        ...
        if (auth()->check()) {
            ...
            if (!empty($course)) {
                if (empty($course->points)) {
                    $toastData = [
                        'title' => '',
                        'msg' => 'Anda tidak dapat membeli pelatihan ini dengan poin.',
                        'status' => 'error'
                    ];
                    return back()->with(['toast' => $toastData]);
                }
                ...
                if ($availablePoints < $course->points) {
                    $toastData = [
                        'title' => '',
                        'msg' => 'Anda tidak memiliki cukup poin untuk mendaftar di pelatihan ini...',
                        'status' => 'error'
                    ];
                    return back()->with(['toast' => $toastData]);
                }
                ...
                $toastData = [
                    'title' => '',
                    'msg' => 'Anda mendaftar di pelatihan menggunakan poin!',
                    'status' => 'success'
                ];
                return back()->with(['toast' => $toastData]);
            }
