!(function (e) {
    ...
    18: function (e, t, r) {
        ...
        !(function (e) {
            var t =
                    '<div class="no-result default-no-result d-flex align-items-center justify-content-center flex-column w-100 h-100">\n        <div class="no-result-logo">\n            <img src="/assets/default/img/no-results/support.png" alt="">\n        </div>\n        <div class="d-flex align-items-center flex-column mt-30 text-center">\n            <h2 class="text-dark-blue">'
                        .concat(
                            liveEndedLang,
                            '</h2>\n            <p class="mt-5 text-center text-gray font-weight-500">'
                        )
                        .concat(
                            redirectToPanelInAFewMomentLang,
                            "</p>\n        </div>\n    </div>"
                        ),
                r = { width: 20, height: 20 },
                n = AgoraRTC.createClient({ mode: "live", codec: "vp8" }),
                i = {
                    videoTrack: null,
                    audioTrack: null,
                                    ...
                                    switch ((t.prev = t.next)) {
                                        case 0:
                                            return (
                                                (t.prev = 0),
                                                "audience" === u.role
                                                    ? (n.setClientRole(u.role, {
                                                          level: u.audienceLatency,
                                                      }),
                                                      n.on("user-published", y),
                                                      n.on(
                                                          "user-unpublished",
                                                          m
                                                      ),
                                ...
                                switch ((t.prev = t.next)) {
                                    ...
                                    case 3:
                                        console.log("subscribe success"),
                                            ...
                                            "audio" === a &&
                                                r.audioTrack.play(),
                                            e(".agora-stream-loading").addClass(
                                                "d-none"
                                            ),
                                            e("#notStartedAlert").removeClass(
                                                "d-flex"
                                            ),
                                            e("#notStartedAlert").addClass(
                                                "d-none"
                                            ),
                                            x(
                                                streamStartAt &&
            ...
            function g(r, n) {
                var o = r.uid;
                e("#player-wrapper-".concat(o)).html(t),
                    setTimeout(function () {
                        redirectAfterLeave &&
                                ...
                                switch ((e.prev = e.next)) {
                                    ...
                                    case 3:
                                        if (
                                            ((r = e.sent),
                                            (c = a(r, 1)),
                                            (t = c[0]) instanceof Array
                                                ? ((i.screenVideoTrack = t[0]),
                                                  (i.screenAudioTrack = t[1]))
                                                : (i.screenVideoTrack = t),
                                            !i.screenVideoTrack)
                                        ) {
                                            e.next = 15;
                                            break;
                                    ...
                                    case 13:
                                        (i.shareScreenActived = !0),
                                            i.screenVideoTrack.on(
                                                "track-ended",
                                                function () {
                                                    f.prop("disabled", !1),
                                                        n
                                                            ...
                                                            .then(function () {
                                                                i.screenVideoTrack.stop(),
                                                                    i.screenVideoTrack.close(),
                                                                    (i.shareScreenActived =
                                                                        !1),
                                                                    w(!1);
                                                            });
                                                }
                        ...
                        return o.a.wrap(function (t) {
                            for (;;)
                                switch ((t.prev = t.next)) {
                                    ...
                                    case 14:
                                        (i.videoTrack = t.sent),
                                            i.videoTrack.play("stream-player"),
                                            n.publish(i.videoTrack);
                                    case 17:
                                        c.find(".icon").html(s);
                                    case 18:
                                    case "end":
            ...
            function x() {
                ...
                function c() {
                    ++i;
                    var e = s(Math.floor(i % 60)),
                        t = s(Math.floor((i / 60) % 60)),
                        r = s(Math.floor((i / 3600) % 24));
            ...
            !(function () {
                ...
                e("body").on("click", "#leave", function (t) {
                    ...
                    var o = "/panel/sessions/" + n + "/endAgora";
                    e.get(o, function (e) {
                        e &&
                            200 === e.code &&
                            (function () {
                ...
                e("body").on("click", "#microphoneEffect", function (t) {
                    var o = e(this),
                        a = feather.icons.mic.toSvg(r);
                    i.audioTrack &&
                        (o.hasClass("active")
                            ? (o.removeClass("active"),
                              o.addClass("disabled"),
                              (a = feather.icons["mic-off"].toSvg(r)),
                              n.unpublish(i.audioTrack))
                            : (o.addClass("active"),
                              o.removeClass("disabled"),
                              n.publish(i.audioTrack))),
                        o.find(".icon").html(a);
                }),
