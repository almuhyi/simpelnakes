...
(function ($) {
  ...
  $(document).ready(function () {
    ...
    function updateToDatabase(table, idString) {
      $.post('/admin/webinars/order-items', {
        table: table,
        items: idString
      }, function (result) {
  ...
  $('body').on('change', '.js-webinar-content-locale', function (e) {
    ...
    var path = '/admin/webinars/' + webinarId + '/getContentItemByLocale';
    var data = {
      item_id: item_id,
      locale: locale,
      relation: relation
    ...
    Swal.fire({
      ...
      onOpen: function onOpen() {
        ...
        if (itemId) {
          ...
          var path = '/admin/chapters/' + itemId + '/update';
  ...
  * */
  ...
  $('body').on('click', '#add_new_Materi', function (e) {
    e.preventDefault();
    var key = randomString();
    ...
    Swal.fire({
      ...
      width: '48rem',
      onOpen: function onOpen() {
        $('#extraDescriptionModal input[name="type"]').val('Materi');
      }
    });
  });
  ...
  $('body').on('click', '#add_new_Logo', function (e) {
    e.preventDefault();
    var key = randomString();
    ...
    Swal.fire({
      ...
      width: '48rem',
      onOpen: function onOpen() {
        $('#extraDescriptionModal input[name="type"]').val('Logo');
      }
    });
  });
  $('body').on('click', '#add_new_Persyaratan', function (e) {
    e.preventDefault();
    var key = randomString();
    var html = '<div id="extraDescriptionModal">';
    html += $('#extraDescriptionForm').html();
    ...
    Swal.fire({
      ...
      width: '48rem',
      onOpen: function onOpen() {
        $('#extraDescriptionModal input[name="type"]').val('Persyaratan');
      }
    });
  });
  ...
  function editExtraDescription($this, locale) {
    ...
    $.post('/admin/webinar-extra-description/' + item_id + '/edit', edit_data, function (result) {
      if (result && result.webinarExtraDescription) {
        ...
        if (webinarExtraDescription.type === 'Logo') {
