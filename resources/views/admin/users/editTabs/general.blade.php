            ...
            <form action="{{ url('') }}/admin/users/{{ $user->id . '/update' }}" method="Post">
                ...
                @if ($user->isUser() || $user->isTeacher())
                    <div class="form-group">
                        ...
                        <select name="organ_id" data-search-option="just_organization_role"
                            class="form-control search-user-select2" data-placeholder="Cari organisasi">
                ...
                <div class="form-group custom-switches-stacked mt-2">
                    <label class="custom-switch pl-0">
                        ...
                        <span class="custom-switch-indicator"></span>
                        <label class="custom-switch-description mb-0 cursor-pointer"
                            for="contentAccessLimitationSwitch">Nonaktifkan Akses Konten</label>
                    </label>
                    <div class="text-muted text-small">Pengguna tidak akan memiliki akses ke semua konten pelatihan.
                    </div>
                </div>
