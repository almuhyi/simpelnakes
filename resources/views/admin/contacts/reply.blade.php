                ...
                <div class="col-12 col-md-12">
                    <div class="card">
                        <div class="card-header flex-column align-items-start">
                            <h4>Username : <span class="text-black-50">{{ $contact->name }}</span></h4>
                            <h4>Email : <span class="text-black-50">{{ $contact->email }}</span></h4>
                            <h4>No HP : <span class="text-black-50">{{ $contact->phone }}</span></h4>
                            <h4>Pesan :</h4>
