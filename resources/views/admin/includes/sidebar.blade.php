                    ...
                    <ul class="dropdown-menu">
                        @can('admin_webinars_list')
                            <li class="{{ (request()->is('admin/webinars') and request()->get('type') == 'pelatihan') ? 'active' : '' }}">
                                <a class="nav-link @if(!empty($sidebarBeeps['courses']) and $sidebarBeeps['courses']) beep beep-sidebar @endif" href="/admin/webinars?type=pelatihan">{{ trans('admin/main.courses') }}</a>
                            </li>
                            ...
                            <li class="{{ (request()->is('admin/webinars') and request()->get('type') == 'teks') ? 'active' : '' }}">
                                <a class="nav-link @if(!empty($sidebarBeeps['textLessons']) and $sidebarBeeps['textLessons']) beep beep-sidebar @endif" href="/admin/webinars?type=teks">{{ trans('admin/main.text_courses') }}</a>
                            </li>
                        @endcan()
