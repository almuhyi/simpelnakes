                ...
                <div class="col-lg-6">
                    <div class="card card-large-icons">
                        ...
                        <div class="card-body">
                            ...
                            <a href="{{ url('/admin/settings/general') }}" class="card-cta">Change Settings<i
                ...
                <div class="col-lg-6">
                    <div class="card card-large-icons">
                        ...
                        <div class="card-body">
                            ...
                            <a href="{{ url('/admin/settings/financial') }}" class="card-cta">Change Settings<i
                                    class="fas fa-chevron-right"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                    <div class="card card-large-icons">
                        ...
                        <div class="card-body">
                            ...
                            <a href="{{ url('/admin/settings/personalization/page_background') }}" class="card-cta">Change
                ...
                <div class="col-lg-6">
                    <div class="card card-large-icons">
                        ...
                        <div class="card-body">
                            ...
                            <a href="{{ url('/admin/settings/notifications') }}" class="card-cta">Change Settings<i
                                    class="fas fa-chevron-right"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                    <div class="card card-large-icons">
                        ...
                        <div class="card-body">
                            ...
                            <a href="{{ url('/admin/settings/seo') }}" class="card-cta">Change Settings<i
                                    class="fas fa-chevron-right"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                    <div class="card card-large-icons">
                        ...
                        <div class="card-body">
                            ...
                            <a href="{{ url('/admin/settings/customization') }}" class="card-cta text-primary">Change
                                Settings<i class="fas fa-chevron-right"></i></a>
                        </div>
                    </div>
                </div>
