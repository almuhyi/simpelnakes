<div class="product-show-reviews-tab mt-20">
    <div class="course-reviews-box row align-items-center">
        <div class="col-3 col-lg-3 text-center">
            ...
            <div class="text-center">
                ...
                <div class="mt-15">{{ $product->reviews->pluck('creator_id')->count() }}  Ulasan</div>
            </div>
        </div>
        ...
        <div class="col-9 col-lg-6">
            <div class="d-flex align-items-center">
                ...
                <span class="ml-15 font-14 text-gray text-left">Produk ({{ $product->reviews->count() > 0 ? round($product->reviews->avg('product_quality'), 1) : 0 }})</span>
            </div>
            ...
            <div class="mt-25 d-flex align-items-center">
                ...
                <span class="ml-15 font-14 text-gray text-left">nilai pembelian ({{ $product->reviews->count() > 0 ? round($product->reviews->avg('purchase_worth'), 1) : 0 }})</span>
            </div>
            ...
            <div class="mt-25 d-flex align-items-center">
                ...
                <span class="ml-15 font-14 text-gray text-left">Pengiriman ({{ $product->reviews->count() > 0 ? round($product->reviews->avg('delivery_quality'), 1) : 0 }})</span>
            </div>
            ...
            <div class="mt-25 d-flex align-items-center">
                ...
                <span class="ml-15 font-14 text-gray text-left">Penjual ({{ $product->reviews->count() > 0 ? round($product->reviews->avg('seller_quality'), 1) : 0 }})</span>
            </div>
    ...
    <section class="mt-40">
        <h2 class="section-title after-line">Ulasan ({{ $product->reviews->pluck('creator_id')->count() }})</h2>
                                ...
                                <div class="btn-group dropdown table-actions">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        @if(!empty($authUser) and $authUser->id == $review->creator_id)
                                            <a href="/products/reviews/{{ $review->id }}/delete" class="delete-action d-block mt-10 text-hover-primary">Hapus</a>
                                        @endif
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div class="btn-group dropdown table-actions">
                                                ...
                                                <div class="dropdown-menu">
                                                    ...
                                                    @if(!empty($authUser) and $authUser->id == $comment->user_id)
                                                        <a href="/comments/{{ $comment->id }}/delete" class="webinar-actions d-block mt-10 text-hover-primary">Hapus</a>
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
