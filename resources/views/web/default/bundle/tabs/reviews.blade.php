    ...
    <div class="course-reviews-box row align-items-center">
        <div class="col-3 text-center">
            ...
            <div class="text-center">
                ...
                <div class="mt-15">{{ $bundle->reviews->pluck('creator_id')->count() }} Ulasan</div>
            </div>
        </div>
        ...
        <div class="col-9">
            <div class="d-flex align-items-center">
                ...
                <span class="ml-15 font-14 text-gray text-left">Kualitas isi materi ({{ $bundle->reviews->count() > 0 ? round($bundle->reviews->avg('content_quality'), 1) : 0 }})</span>
            </div>
            ...
            <div class="mt-25 d-flex align-items-center">
                ...
                <span class="ml-15 font-14 text-gray text-left">Keterampilan instruktur ({{ $bundle->reviews->count() > 0 ? round($bundle->reviews->avg('instructor_skills'), 1) : 0 }})</span>
            </div>
            ...
            <div class="mt-25 d-flex align-items-center">
                ...
                <span class="ml-15 font-14 text-gray text-left">Nilai pembelian ({{ $bundle->reviews->count() > 0 ? round($bundle->reviews->avg('purchase_worth'), 1) : 0 }})</span>
            </div>
            ...
            <div class="mt-25 d-flex align-items-center">
                ...
                <span class="ml-15 font-14 text-gray text-left">Kualitas dukungan ({{ $bundle->reviews->count() > 0 ? round($bundle->reviews->avg('support_quality'), 1) : 0 }})</span>
            </div>
...
<section class="mt-40">
    <h2 class="section-title after-line">Ulasan ({{ $bundle->reviews->pluck('creator_id')->count() }})</h2>
                            ...
                            <div class="btn-group dropdown table-actions">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    @if(!empty($user) and $user->id == $review->creator_id)
                                        <a href="/bundles/reviews/{{ $review->id }}/delete" class="webinar-actions d-block mt-10 text-hover-primary">Hapus</a>
                                    @endif
                                </div>
                            </div>
                        </div>
