            ...
            <div class="navbar-shopping-cart h-100" data-simplebar>
                @if(!empty($userCarts) and count($userCarts) > 0)
                        ...
                        @foreach($userCarts as $cart)
                            ...
                            @if(!empty($cartItemInfo))
                                <div class="navbar-cart-box d-flex align-items-center">
                                    ...
                                    <a href="{{ url($cartItemInfo['itemUrl']) }}" target="_blank" class="navbar-cart-img">
                                        <img src="{{ asset($cartItemInfo['imgPath']) }}" alt="product title" class="img-cover"/>
                                    </a>
                                    ...
                                    <div class="navbar-cart-info">
                                        ...
                                        <div class="price mt-10">
                                            ...
                                            @if(!empty($cartItemInfo['quantity']))
                                                <span class="font-12 text-warning font-weight-500 ml-10">({{ $cartItemInfo['quantity'] }} Produk)</span>
                                            @endif
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="navbar-cart-actions">
                        ...
                        <a href="{{ url('/cart') }}" class="btn btn-sm btn-primary btn-block mt-50 mt-md-15">Lihat keranjang</a>
                    </div>
                @else
