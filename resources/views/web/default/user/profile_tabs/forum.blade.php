                ...
                <div class="col-12 col-md-6">
                    <div class="d-flex align-items-center">
                        <div class="topic-user-avatar rounded-circle">
                            <img src="{{ asset($user->getAvatar()) }}" class="img-cover rounded-circle" alt="{{ $user->full_name }}">
                        </div>
                        <div class="ml-10 mw-100">
                            ...
                            <span class="d-block font-14 text-gray">Oleh {{ $user->full_name }} pada {{ dateTimeFormat($topic->created_at,'j M Y | H:i') }}</span>
                        </div>
                    </div>
                </div>
