    ...
    <div class="container">
        ...
        <div class="row login-container">
            <div class="col-12 col-md-6 pl-0">
                <img src="{{ asset(getPageBackgroundSettings('become_instructor')) }}" class="img-cover" alt="Login">
            </div>
            ...
            <div class="col-12 col-md-6">
                <div class="login-card">
                    ...
                    <form method="Post" action="{{ url('/become_instructor') }}" class="mt-35">
                        {{ csrf_field() }}

                        <div class="form-group">
                            <label class="font-weight-500 text-dark-blue">Pekerjaan</label>
                        ...
                        <div class="form-group">
                            <label class="input-label">Sertifikat dan dokumen</label>
                        ...
                        <div class="form-group">
                            <label class="input-label">ID Akun</label>
                        ...
                        <div class="form-group">
                            <label class="input-label">Tambahan Informasi</label>
                            <textarea name="description" rows="6" class="form-control">{{ !empty($lastRequest) ? $lastRequest->description : old('description') }}</textarea>
                        </div>

                        <button type="submit" class="btn btn-primary btn-block mt-20">Kirim permintaan</button>
                    </form>
