                    ...
                    <form method="post" action="{{ url('/register') }}" class="mt-35">
                        ...
                        {{-- @if(getFeaturesSettings('timezone_in_register'))
                            ...
                            <div class="form-group">
                                ...
                                <select name="timezone" class="form-control select2" data-allow-clear="false">
                                    <option value="" {{ empty($user->timezone) ? 'selected' : '' }} disabled>Pilih zona waktu</option>
                        ...
                        <div class="custom-control custom-checkbox">
                            ...
                            <label class="custom-control-label font-14" for="term">
                                <a href="{{ url('pages/terms') }}" target="_blank" class="text-secondary font-weight-bold font-14">Saya setuju dengan syarat & aturan</a>
                            </label>
