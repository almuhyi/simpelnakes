...
@section('content')
            ...
            <div class="row">
                <div class="col-6 col-md-3 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        <img src="{{ asset('') }}assets/default/img/activity/43.svg" width="64" height="64" alt="">
                ...
                <div class="col-6 col-md-3 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        <img src="{{ asset('') }}assets/default/img/activity/42.svg" width="64" height="64" alt="">
    ...
    <section class="mt-25">
        ...
        <div class="panel-section-card py-20 px-25 mt-20">
            <form action="{{ url('/panel/quizzes/results') }}" method="get" class="row">
                                ...
                                <div class="col-12 col-lg-5">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="status" name="status">
                                            <option value="all">Semua</option>
                                            <option value="passed" {{ request()->get('status','') === "passed" ? 'selected' : '' }}>Lulus</option>
                                            <option value="failed" {{ request()->get('status','') === "failed" ? 'selected' : '' }}>Gagal</option>
                                            <option value="waiting" {{ request()->get('status','') === "waiting" ? 'selected' : '' }}>Menunggu</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
    ...
    <section class="mt-35">
        <div class="d-flex align-items-start align-items-md-center justify-content-between flex-column flex-md-row">
            ...
            <form action="{{ url('/panel/quizzes/results') }}" method="get" class="">
                                        ...
                                        <td class="text-left align-middle">
                                            <div class="user-inline-avatar d-flex align-items-center">
                                                <div class="avatar bg-gray200">
                                                    <img src="{{ asset($result->user->getAvatar()) }}" class="img-cover" alt="">
                                                </div>
                                                <div class=" ml-5">
                                            ...
                                            <div class="btn-group dropdown table-actions table-actions-lg table-actions-lg">
                                                ...
                                                <div class="dropdown-menu font-weight-normal">
                                                    @if($result->status != 'waiting')
                                                        <a href="{{ url('') }}/panel/quizzes/{{ $result->id }}/result" class="webinar-actions d-block mt-10">Lihat</a>
                                                    @endif

                                                    @if($result->status == 'waiting')
                                                        <a href="{{ url('') }}/panel/quizzes/{{ $result->id }}/edit-result" class="webinar-actions d-block mt-10">Tinjau</a>
                                                    @endif

                                                    <a href="{{ url('') }}/panel/quizzes/results/{{ $result->id }}/delete" class="webinar-actions d-block mt-10 delete-action">Hapus</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
