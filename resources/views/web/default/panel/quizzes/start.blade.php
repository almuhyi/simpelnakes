    ...
    <div class="container">
        <section class="mt-40">
            ...
            <p class="text-gray font-14 mt-5">
                <a href="{{ url($quiz->webinar->getUrl()) }}" target="_blank" class="text-gray">{{ $quiz->webinar->title }}</a>
                | Oleh
                <span class="font-weight-bold">
                    <a href="{{ url($quiz->creator->getProfileUrl()) }}" target="_blank" class="font-14"> {{ $quiz->creator->full_name }}</a>
                </span>
            </p>
                ...
                <div class="row">
                    <div class="col-6 col-md-3 d-flex align-items-center justify-content-center">
                        <div class="d-flex flex-column align-items-center text-center">
                            ...
                            <span class="font-16 text-gray">Minimal Nilai</span>
                        </div>
                    </div>
                    ...
                    <div class="col-6 col-md-3 d-flex align-items-center justify-content-center">
                        <div class="d-flex flex-column align-items-center text-center">
                            ...
                            <span class="font-16 text-gray">Percobaan</span>
                        </div>
                    </div>
                    ...
                    <div class="col-6 col-md-3 mt-30 mt-md-0 d-flex align-items-center justify-content-center mt-5 mt-md-0">
                        <div class="d-flex flex-column align-items-center text-center">
                            ...
                            <span class="font-16 text-gray">Pertanyaan</span>
                        </div>
                    </div>

                    <div class="col-6 col-md-3 mt-30 mt-md-0 d-flex align-items-center justify-content-center mt-5 mt-md-0">
                        <div class="d-flex flex-column align-items-center text-center">
                            <img src="{{ asset('') }}assets/default/img/activity/clock.svg" width="64" height="64" alt="">
                            @if(!empty($quiz->time))
                            ...
                            @else
                                <strong class="font-30 font-weight-bold text-secondary mt-5">
                                    Tak terbatas</strong>
                            @endif
                            <span class="font-16 text-gray">Waktu yang tersisa</span>
                        </div>
                    </div>
        ...
        <section class="mt-30 quiz-form">
            <form action="{{ url('') }}/panel/quizzes/{{ $quiz->id }}/store-result" method="post" class="">
                {{ csrf_field() }}
                            ...
                            <div class="quiz-card">
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    <p class="text-gray font-14">
                                        <span>Nilai pertanyaan : {{ $question->grade }} </span>
                                    </p>
                                ...
                                @if(!empty($question->image) or !empty($question->video))
                                    <div class="quiz-question-media-card rounded-lg mt-10 mb-15">
                                        @if(!empty($question->image))
                                            <img src="{{ asset($question->image) }}" class="img-cover rounded-lg" alt="">
                                        @else
                ...
                <div class="d-flex align-items-center mt-30">
                    <button type="button" class="previous btn btn-sm btn-primary mr-20">Pertanyaan sebelumnya</button>
                    <button type="button" class="next btn btn-sm btn-primary mr-auto">Pertanyaan selanjutnya</button>
...
@push('scripts_bottom')
    ...
    <script src="{{ asset('') }}assets/default/vendors/jquery.simple.timer/jquery.simple.timer.js"></script>
