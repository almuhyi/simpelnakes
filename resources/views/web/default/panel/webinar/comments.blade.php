...
@section('content')
    ...
    <section class="mt-25">
        ...
        <div class="panel-section-card py-20 px-25 mt-20">
            <form action="{{ url('/panel/webinars/comments') }}" method="get" class="row">
                                ...
                                @foreach($comments as $comment)
                                    <tr>
                                        ...
                                        <td class=" text-left align-middle" width="35%">
                                            <a href="{{ url($comment->webinar->getUrl()) }}" target="_blank" class="text-dark-blue font-weight-500">{{ $comment->webinar->title }}</a>
                                        </td>
                                        ...
                                        <td class="align-middle text-right">
                                            ...
                                            <div class="btn-group dropdown table-actions">
                                                ...
                                                <div class="dropdown-menu">
                                                    <button type="button" data-comment-id="{{ $comment->id }}" class="js-reply-comment btn-transparent">Balas</button>
                                                    <button type="button" data-item-id="{{ $comment->webinar_id }}" data-comment-id="{{ $comment->id }}" class="btn-transparent webinar-actions d-block mt-10 text-hover-primary report-comment">Laporkan</button>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
...
@push('scripts_bottom')
    ...
    <script>
        ...
        var reportSuccessLang = '{{ ('Laporkan berhasil!') }}';
