    ...
    <div class="course-forum-top-stats d-flex flex-wrap flex-md-nowrap align-items-center justify-content-around">
        <div class="d-flex align-items-center justify-content-center pb-5 pb-md-0">
            <div class="d-flex flex-column align-items-center text-center">
                <img src="{{ asset('') }}assets/default/img/activity/47.svg" class="course-forum-top-stats__icon" alt="">
        ...
        <div class="d-flex align-items-center justify-content-center pb-5 pb-md-0">
            <div class="d-flex flex-column align-items-center text-center">
                <img src="{{ asset('') }}assets/default/img/activity/120.svg" class="course-forum-top-stats__icon" alt="">
        ...
        <div class="d-flex align-items-center justify-content-center pb-5 pb-md-0">
            <div class="d-flex flex-column align-items-center text-center">
                <img src="{{ asset('') }}assets/default/img/activity/119.svg" class="course-forum-top-stats__icon" alt="">
        ...
        <div class="d-flex align-items-center justify-content-center pb-5 pb-md-0">
            <div class="d-flex flex-column align-items-center text-center">
                <img src="{{ asset('') }}assets/default/img/activity/39.svg" class="course-forum-top-stats__icon" alt="">
        ...
        <div class="d-flex align-items-center justify-content-center pb-5 pb-md-0">
            <div class="d-flex flex-column align-items-center text-center">
                <img src="{{ asset('') }}assets/default/img/activity/49.svg" class="course-forum-top-stats__icon" alt="">
            ...
            <div class="col-12 col-lg-5 mt-15 mt-lg-0">
                <form action="{{ url(request()->url()) }}" method="get">
                    <div class="d-flex align-items-center">
                        <input type="text" name="search" class="form-control flex-grow-1" value="{{ request()->get('search') }}" placeholder="cari di forum ini">
            ...
            <div class="row">
                <div class="col-12 col-lg-6">
                    <div class="d-flex align-items-start">
                        <div class="question-user-avatar">
                            <img src="{{ asset($forum->user->getAvatar(64)) }}" class="img-cover rounded-circle" alt="{{ $forum->user->full_name }}">
                        </div>
                        <div class="ml-10">
                            <a href="{{ url($course->getForumPageUrl()) }}/{{ $forum->id }}/answers" class="">
                                <h4 class="font-16 font-weight-bold text-dark-blue">{{ $forum->title }}</h4>
                            </a>

                            <span class="d-block font-12 text-gray mt-5">Oleh {{ $forum->user->full_name }} Pada {{ dateTimeFormat($forum->created_at, 'j M Y | H:i') }}</span>
                ...
                <div class="col-12 col-lg-6 mt-15 mt-lg-0 border-left">
                    @if($course->isOwner($user->id))
                        <button type="button" data-action="{{ url($course->getForumPageUrl()) }}/{{ $forum->id }}/pinToggle" class="question-forum-pin-btn d-flex align-items-center justify-content-center">
                            <img src="{{ asset('') }}assets/default/img/learning/{{ $forum->pin ? 'un_pin' : 'pin' }}.svg" alt="pin icon" class="">
                        </button>
                    @endif
                        ...
                        <div class="py-15 border-top position-relative">
                            ...
                            <div class="d-flex align-items-start mt-20">
                                <div class="last-answer-user-avatar">
                                    <img src="{{ asset($forum->lastAnswer->user->getAvatar(30)) }}" class="img-cover rounded-circle" alt="{{ $forum->lastAnswer->user->full_name }}">
                                </div>
                                <div class="ml-10">
                    ...
                    @else
                        <div class="d-flex flex-column justify-content-center text-center py-15 h-100">
                            ...
                            <div class="">
                                <a href="{{ url($course->getForumPageUrl()) }}/{{ $forum->id }}/answers" class="btn btn-primary btn-sm mt-15">Jawab</a>
                            </div>
                        </div>
                    @endif
                </div>
