    ...
    <div class="assignment-top-stats d-flex flex-wrap flex-md-nowrap align-items-center justify-content-around">
        <div class="assignment-top-stats__item d-flex align-items-center justify-content-center pb-5 pb-md-0">
            <div class="d-flex flex-column align-items-center text-center">
                <img src="{{ asset('') }}assets/default/img/activity/calendar.svg" class="assignment-top-stats__icon" alt="">
                <strong class="font-20 text-dark-blue font-weight-bold mt-5">
                    @if($assignmentDeadline)
                        {{ is_bool($assignmentDeadline) ? ('Tak terbatas') : ceil($assignmentDeadline) }} Hari
                    @else
        ...
        <div class="assignment-top-stats__item d-flex align-items-center justify-content-center pb-5 pb-md-0">
            <div class="d-flex flex-column align-items-center text-center">
                <img src="{{ asset('') }}assets/default/img/activity/homework.svg" class="assignment-top-stats__icon" alt="">
                <strong class="font-20 text-dark-blue font-weight-bold mt-5">
        ...
        <div class="assignment-top-stats__item d-flex align-items-center justify-content-center pb-5 pb-md-0">
            <div class="d-flex flex-column align-items-center text-center">
                <img src="{{ asset('') }}assets/default/img/activity/45.svg" class="assignment-top-stats__icon" alt="">
        ...
        <div class="assignment-top-stats__item d-flex align-items-center justify-content-center pb-5 pb-md-0">
            <div class="d-flex flex-column align-items-center text-center">
                <img src="{{ asset('') }}assets/default/img/activity/58.svg" class="assignment-top-stats__icon" alt="">
        ...
        <div class="assignment-top-stats__item d-flex align-items-center justify-content-center pb-5 pb-md-0">
            <div class="d-flex flex-column align-items-center text-center">
                <img src="{{ asset('') }}assets/default/img/activity/88.svg" class="assignment-top-stats__icon" alt="">
                <strong class="font-20 text-dark-blue font-weight-bold mt-5">{{ $assignmentHistory->status }}</strong>
        ...
        <div class="row">
            @foreach($assignment->attachments as $attachment)
                <div class="col-6 col-lg-3 mt-10">
                    <a href="{{ url($attachment->getDownloadUrl()) }}" target="_blank" class="d-flex align-items-center p-10 border rounded-sm">
            ...
            <div class="col-12 col-lg-4">
                    ...
                    <div class="d-flex align-items-center justify-content-center flex-column bg-info-light p-10 rounded-sm border h-100">
                        <div class="learning-page-assignment-history-status-icon d-flex align-items-center justify-content-center">
                            @if($assignmentHistory->status == \App\Models\WebinarAssignmentHistory::$passed)
                                <img src="{{ asset('') }}assets/default/img/learning/assignment_passed.svg" class="img-fluid" alt="">
                            @elseif($assignmentHistory->status == \App\Models\WebinarAssignmentHistory::$notPassed)
                                <img src="{{ asset('') }}assets/default/img/learning/no_assignment.svg" class="img-fluid" alt="">
                            @else
                                <img src="{{ asset('') }}assets/default/img/learning/assignment_pending.svg" class="img-fluid" alt="">
                            @endif
                        </div>
                ...
                @else
                    <div class="bg-info-light p-10 rounded-sm border">
                        ...
                        <form method="post" action="{{ url('') }}/course/assignment/{{ $assignment->id }}/history/{{ $assignmentHistory->id }}/message">
                            {{ csrf_field() }}
                    ...
                    @if($user->id == $assignment->creator_id)
                        <div class="bg-info-light p-10 rounded-sm border mt-15">
                            ...
                            <form method="post" action="{{ url('') }}/course/assignment/{{ $assignment->id }}/history/{{ $assignmentHistory->id }}/setGrade">
                                <input type="hidden" name="student_id" value="{{ $assignmentHistory->student_id }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="d-flex align-items-start">
                                        <div class="mr-10 w-100">
                                            <input name="grade" class="form-control" placeholder="Nilai lulus: {{ $assignment->pass_grade }}"/>
                                            <div class="invalid-feedback"></div>
                                        </div>
                            ...
                            <div class="assignment-attachments-post p-15 border rounded-sm mb-15">
                                <div class="d-flex align-items-center">
                                    <div class="user-avatar rounded-circle">
                                        <img src="{{ asset($message->sender->getAvatar(50)) }}" class="img-cover rounded-circle" alt="{{ $message->sender->full_name }}">
                                    </div>
                                    <div class="ml-10">
                                ...
                                @if(!empty($message->file_path))
                                    <div class="d-flex flex-wrap align-items-center mt-10">
                                        <a href="{{ url($message->getDownloadUrl($assignment->id)) }}" target="_blank" class="d-flex align-items-center text-gray bg-info-light border px-10 py-5 rounded-pill mr-10 mt-5">
                                            <i data-feather="paperclip" class="text-gray" width="16" height="16"></i>
                                            <span class="ml-5 font-12 text-gray">{{ !empty($message->file_title) ? $message->file_title : ('Lampiran') }}</span>
                                        </a>
                                    </div>
                                @endif
                            </div>
