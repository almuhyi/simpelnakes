...
@push('styles_top')
    <link rel="stylesheet" href="{{ asset('') }}assets/default/agora/agora.css"/>
@endpush
...
@section('content')
    ...
    <div class="agora-page">
        <div class="agora-navbar d-flex align-items-center justify-content-between shoa px-35 py-10">
            <div class="">
                <a class="navbar-brand d-flex align-items-center justify-content-center mr-0" href="{{ url('/') }}">
                    ...
                    <li class="nav-item">
                        <a class="position-relative font-14 d-flex align-items-center active" id="chat-tab"
                           ...
                           aria-selected="true">
                            ...
                            <span class="agora-tabs-link-text">Obrolan</span>
                        </a>
                    </li>
...
@push('scripts_top')
    <script>
        ...
        var joinedToChannel = '{{ ('Bergabung dengan sesi langsung...') }}';
        var appId = '{{ $appId }}';
        var accountName = '{{ $accountName }}';
        var channelName = '{{ $channelName }}';
        var streamRole = '{{ $streamRole }}';
        var redirectAfterLeave = '{{ url('/panel') }}';
        var liveEndedLang = '{{ ('Live ini telah berakhir.') }}';
        var redirectToPanelInAFewMomentLang = '{{ ('Anda akan dialihkan ke panel dalam beberapa saat...') }}';
