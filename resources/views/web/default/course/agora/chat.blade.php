    ...
    @if($session->agora_settings->chat)
        ...
        <div class="mt-15 py-15 px-15 border-top border-gray200 d-flex align-items-center ">
            ...
            <div class="flex-grow-1">
                <textarea name="message" id="messageInput" class="form-control " rows="3" placeholder="Ketik pesan anda..."></textarea>
            </div>
    ...
    @else
        <div class="no-result default-no-result d-flex align-items-center justify-content-center flex-column w-100 h-100 pb-40">
            ...
            <div class="d-flex align-items-center flex-column mt-30 text-center">
                <h3 class="text-dark-blue font-16">Obrolan Dinonaktifkan...</h3>
                <p class="mt-5 text-center text-gray font-14">Obrolan tidak tersedia untuk kelas ini!</p>
            </div>
        </div>
    @endif
</div>
...
@push('scripts_bottom')
    @if($session->agora_settings->chat)
        ...
        <script src="{{ asset('') }}assets/default/agora/message.min.js"></script>
    @endif
@endpush
