            ...
            <div class="d-flex align-items-center justify-content-between mt-20">
                ...
                <div class="d-flex align-items-center">
                    <div class="d-flex align-items-center text-gray text-center font-14 mr-20">
                        ...
                        <span class="line-height-1">Nilai Min: {{ $assignment->pass_grade }}</span>
                    </div>
                </div>
                ...
                <div class="">
                    ...
                    @elseif(!empty($user) and $hasBought)
                        <a href="{{ url($course->getLearningPageUrl()) }}?type=assignment&item={{ $assignment->id }}" target="_blank" class="course-content-btns btn btn-sm btn-primary">
                            Baca
                        </a>
                    @else
