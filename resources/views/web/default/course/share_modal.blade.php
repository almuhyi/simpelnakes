<div class="d-none" id="courseShareModal">
    ...
    <div class="text-center">
        ...
        <div class="mt-32 mt-lg-40 row align-items-center font-14">
            <a href="{{ url($course->getShareLink('telegram')) }}" target="_blank" class="col text-center">
                <img src="{{ asset('') }}assets/default/img/social/telegram.svg" width="50" height="50" alt="telegram">
                <span class="mt-10 d-block">Telegram</span>
            </a>

            <a href="{{ url($course->getShareLink('whatsapp')) }}" target="_blank" class="col text-center">
                <img src="{{ asset('') }}assets/default/img/social/whatsapp.svg" width="50" height="50" alt="whatsapp">
                <span class="mt-10 d-block">Whatsapp</span>
            </a>

            <a href="{{ url($course->getShareLink('facebook')) }}" target="_blank" class="col text-center">
                <img src="{{ asset('') }}assets/default/img/social/facebook.svg" width="50" height="50" alt="facebook">
                <span class="mt-10 d-block">Facebook</span>
            </a>

            <a href="{{ url($course->getShareLink('twitter')) }}" target="_blank" class="col text-center">
                <img src="{{ asset('') }}assets/default/img/social/twitter.svg" width="50" height="50" alt="twitter">
