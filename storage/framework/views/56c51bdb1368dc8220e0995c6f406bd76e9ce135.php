                        ...
                        <div class="col-12 col-lg-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="status" name="status">
                                    <option value="all">Semua</option>
                                    <option value="published" <?php if(request()->get('status') == 'published'): ?> selected <?php endif; ?> >Dipublish</option>
                                    <option value="closed" <?php if(request()->get('status') == 'closed'): ?> selected <?php endif; ?> >Ditutup</option>
                                </select>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('web.default.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\simpelnakes\resources\views/web/default/panel/forum/topics.blade.php ENDPATH**/ ?>