<?php
    ...
    if ($type == \App\Models\WebinarChapter::$chapterSession) {
        $icon = 'video';
        $hintText = dateTimeFormat($item->date, 'j M Y  H:i') . ' | ' . $item->duration . ' ' . ('Menit');
        ...
        $icon = 'file-text';
        $hintText= $item->study_time . ' ' . ('Menit');
    }
    ...
    <div>
        ...
        <div class="tab-item-info mt-15">
            ...
            <div class="d-flex align-items-center justify-content-between mt-15">
                <label class="mb-0 mr-10 cursor-pointer font-weight-normal font-14 text-dark-blue" for="readToggle<?php echo e($type); ?><?php echo e($item->id); ?>">Saya lulus pelajaran ini</label>
...
<?php /**PATH C:\laragon\www\simpelnakes\resources\views/web/default/course/learningPage/components/content_tab/content.blade.php ENDPATH**/ ?>