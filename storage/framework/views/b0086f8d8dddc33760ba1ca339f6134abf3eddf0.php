        ...
        <div class="d-flex flex-column h-100">
            <div class="mb-auto navbar-notification-card" data-simplebar>
                ...
                <?php if(!empty($unReadNotifications) and count($unReadNotifications)): ?>
                    ...
                    <?php $__currentLoopData = $unReadNotifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unReadNotification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e(url('')); ?>/panel/notifications?notification=<?php echo e($unReadNotification->id); ?>">
                ...
                <?php else: ?>
                    <div class="d-flex align-items-center text-center py-50">
                        <i data-feather="bell" width="20" height="20" class="mr-10"></i>
                        <span class="">Tidak ada pemberitahuan</span>
                    </div>
                <?php endif; ?>
            ...
            <?php if(!empty($unReadNotifications) and count($unReadNotifications)): ?>
                <div class="mt-10 navbar-notification-action">
                    <a href="<?php echo e(url('/panel/notifications')); ?>" class="btn btn-sm btn-danger btn-block">Semua pemberitahuan</a>
                </div>
            <?php endif; ?>
        </div>
    </div>
</div>
<?php /**PATH C:\laragon\www\simpelnakes\resources\views/web/default/includes/notification-dropdown.blade.php ENDPATH**/ ?>