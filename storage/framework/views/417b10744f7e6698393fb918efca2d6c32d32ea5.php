...
<?php $__env->startSection('content'); ?>
    <section class="site-top-banner search-top-banner opacity-04 position-relative">
        <img src="<?php echo e(asset(getPageBackgroundSettings($page))); ?>" class="img-cover" alt=""/>
                ...
                <div class="col-12 col-md-9 col-lg-7">
                    <div class="top-search-categories-form">
                        ...
                        <div class="search-input bg-white p-10 flex-grow-1">
                            <form action="<?php echo e(url('/{{ $page); ?>') }}" method="get">
                                <div class="form-group d-flex align-items-center m-0">
                                    <input type="text" name="search" class="form-control border-0" value="<?php echo e(request()->get('search')); ?>" placeholder="Cari <?php echo e($title); ?>"/>
    ...
    <div class="container">
        ...
        <form id="filtersForm" action="<?php echo e(url('/{{ $page); ?>') }}" method="get">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-9 d-block d-md-flex align-items-center justify-content-start my-25 my-lg-0">
                        ...
                        <div class="d-flex align-items-center justify-content-between justify-content-md-center mx-0 mx-md-20 my-20 my-md-0">
                            <label class="mb-0 mr-10 cursor-pointer" for="free_meetings">Pertemuan gratis</label>
                            <div class="custom-control custom-switch">
                        ...
                        <div class="d-flex align-items-center justify-content-between justify-content-md-center">
                            <label class="mb-0 mr-10 cursor-pointer" for="discount">Diskon</label>
                            <div class="custom-control custom-switch">
                    ...
                    <div class="col-lg-3 d-flex align-items-center">
                        <select name="sort" class="form-control">
                            <option disabled selected>Filter dengan</option>
                            <option value="">Semua</option>
                            <option value="top_rate" <?php if(request()->get('sort',null) == 'top_rate'): ?> selected="selected" <?php endif; ?>>Top rate</option>
            ...
            <div class="mt-30 px-20 py-15 rounded-sm shadow-lg border border-gray300">
                <h3 class="category-filter-title font-20 font-weight-bold">Kategori</h3>
        ...
        <section>
            ...
            <div class="text-center">
                <button type="button" id="loadMoreInstructors" data-page="<?php echo e(($page == 'instructors') ? \App\Models\Role::$teacher : \App\Models\Role::$organization); ?>" class="btn btn-border-white mt-50 <?php echo e(($instructors->lastPage() <= $instructors->currentPage()) ? ' d-none' : ''); ?>">Muat instruktur lainnya</button>
            </div>
        </section>
        ...
        <?php if(!empty($bestRateInstructors) and !$bestRateInstructors->isEmpty() and (empty(request()->get('sort')) or !in_array(request()->get('sort'),['top_rate','top_sale']))): ?>
            <section class="mt-30 pt-30">
                <div class="d-flex justify-content-between">
                    <div>
                        <h2 class="font-24 text-dark-blue">Instruktur rating top</h2>
                        <span class="font-14 text-gray">subtitle instruktur dengan peringkat terbaik</span>
                    </div>

                    <a href="<?php echo e(url('/{{ $page); ?>?sort=top_rate')}}" class="btn btn-border-white">Lihat semua</a>
                </div>
        ...
        <?php if(!empty($bestSalesInstructors) and !$bestSalesInstructors->isEmpty() and (empty(request()->get('sort')) or !in_array(request()->get('sort'),['top_rate','top_sale']))): ?>
            <section class="mt-50 pt-50">
                <div class="d-flex justify-content-between">
                    <div>
                        <h2 class="font-24 text-dark-blue">Top penjualan</h2>
                        <span class="font-14 text-gray">Subtitle penjualan top</span>
                    </div>

                    <a href="<?php echo e(url('/{{ $page); ?>?sort=top_sale')}}" class="btn btn-border-white">Lihat semua</a>
                </div>
...
<?php echo $__env->make(getTemplate().'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\simpelnakes\resources\views/web/default/pages/instructors.blade.php ENDPATH**/ ?>