...
<?php else: ?>
    <?php echo $__env->make(getTemplate() . '.includes.no-result',[
        ...
        'title' => ('Instruktur tidak memiliki pelatihan apa pun!'),
        'hint' => '',
    ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php endif; ?>

<?php /**PATH C:\laragon\www\simpelnakes\resources\views/web/default/user/profile_tabs/webinars.blade.php ENDPATH**/ ?>