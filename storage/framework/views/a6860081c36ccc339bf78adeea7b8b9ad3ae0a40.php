...
<div class="wizard-step-1">
    <h3 class="font-20 text-dark font-weight-bold">Waktu pertemuan</h3>

    <span class="d-block mt-30 text-gray wizard-step-num">
        Langkah 4/4
    </span>

    <span class="d-block font-16 font-weight-500 mt-30">Waktu apa yang Anda sukai untuk pertemuan?</span>
    ...
    <div class="mb-30 custom-control custom-checkbox mt-30 full-checkbox w-100">
        ...
        <label class="custom-control-label font-14 w-100" for="date">Saya fleksibel</label>
    </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\laragon\www\simpelnakes\resources\views/web/default/instructorFinder/wizard/step_4.blade.php ENDPATH**/ ?>