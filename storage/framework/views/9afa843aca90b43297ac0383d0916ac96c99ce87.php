<div class="add-answer-card mt-25 <?php echo e((empty($answer) or (!empty($loop) and $loop->iteration == 1)) ? 'main-answer-row' : ''); ?>">
    ...
    <div class="row mt-15 align-items-end">
        <div class="col-12 col-md-8">
            <div class="form-group">
                <label class="input-label">Gambar jawaban (Opsional)</label>
        ...
        <div class="col-12 col-md-4">
            <div class="form-group mt-20 d-flex align-items-center justify-content-between js-switch-parent">
                <label class="js-switch input-label" for="correctAnswerSwitch<?php echo e(!empty($answer) ? $answer->id : ''); ?>">Jawaban yang benar</label>
...
<?php /**PATH C:\laragon\www\simpelnakes\resources\views/web/default/panel/quizzes/modals/multiple_answer_form.blade.php ENDPATH**/ ?>