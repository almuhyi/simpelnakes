    ...
    <div class="course-reviews-box row align-items-center">
        <div class="col-3 text-center">
            ...
            <div class="text-center">
                ...
                <div class="mt-15"><?php echo e($bundle->reviews->pluck('creator_id')->count()); ?> Ulasan</div>
            </div>
        </div>
        ...
        <div class="col-9">
            <div class="d-flex align-items-center">
                ...
                <span class="ml-15 font-14 text-gray text-left">Kualitas konten materi (<?php echo e($bundle->reviews->count() > 0 ? round($bundle->reviews->avg('content_quality'), 1) : 0); ?>)</span>
            </div>
            ...
            <div class="mt-25 d-flex align-items-center">
                ...
                <span class="ml-15 font-14 text-gray text-left">Keterampilan instruktur (<?php echo e($bundle->reviews->count() > 0 ? round($bundle->reviews->avg('instructor_skills'), 1) : 0); ?>)</span>
            </div>
            ...
            <div class="mt-25 d-flex align-items-center">
                ...
                <span class="ml-15 font-14 text-gray text-left">Nilai pembelian (<?php echo e($bundle->reviews->count() > 0 ? round($bundle->reviews->avg('purchase_worth'), 1) : 0); ?>)</span>
            </div>
            ...
            <div class="mt-25 d-flex align-items-center">
                ...
                <span class="ml-15 font-14 text-gray text-left">Kualitas dukungan (<?php echo e($bundle->reviews->count() > 0 ? round($bundle->reviews->avg('support_quality'), 1) : 0); ?>)</span>
            </div>
...
<section class="mt-40">
    <h2 class="section-title after-line">Ulasan (<?php echo e($bundle->reviews->pluck('creator_id')->count()); ?>)</h2>
    ...
    <form action="/bundles/reviews/store" class="mt-20" method="post">
        ...
        <div class="reviews-stars row align-items-center">
            ...
            <div class="col-6 col-md-3 d-flex flex-column align-items-center justify-content-center barrating-stars">
                <span class="font-14 text-gray">Kualitas konten materi</span>
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="btn-group dropdown table-actions">
                                ...
                                <div class="dropdown-menu">
                                    <a href="/bundles/reviews/store-reply-comment" class="webinar-actions d-block text-hover-primary reply-comment">Balas</a>

                                    <?php if(!empty($user) and $user->id == $review->creator_id): ?>
                                        <a href="/bundles/reviews/<?php echo e($review->id); ?>/delete" class="webinar-actions d-block mt-10 text-hover-primary">Hapus</a>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
...
<?php /**PATH C:\laragon\www\simpelnakes\resources\views/web/default/bundle/tabs/reviews.blade.php ENDPATH**/ ?>