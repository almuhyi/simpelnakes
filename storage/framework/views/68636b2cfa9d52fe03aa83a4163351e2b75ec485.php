...
<?php $__env->startSection('content'); ?>
    <section class="section">
        <div class="section-header">
            <h1><?php echo e(!empty($forum) ?'Edit': 'Baru'); ?> Forum</h1>
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item"><?php echo e(!empty($forum) ?'Edit': 'Baru'); ?></div>
            </div>
        </div>
                                                ...
                                                <li class="form-group list-group  border rounded-lg p-2">
                                                    ...
                                                    <div class="form-group mb-0 mt-1">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" name="sub_forums[<?php echo e($subForum->id); ?>][icon]" id="icon_<?php echo e($subForum->id); ?>" class="form-control" value="<?php echo e($subForum->icon); ?>" placeholder="Icon"/>
                                                        </div>
                                                    </div>

                                                    <textarea name="sub_forums[<?php echo e($subForum->id); ?>][description]"
                                                              class="form-control w-auto flex-grow-1 mt-1" placeholder="Deskripsi"><?php echo e($subForum->description); ?></textarea>
                                                    ...
                                                    <div class="form-group mb-0 mt-1 custom-switches-stacked">
                                                        <label class="custom-switch pl-0 d-flex align-items-center mb-0">
                                                            ...
                                                            <span class="custom-switch-indicator"></span>
                                                            <label class="custom-switch-description mb-0 cursor-pointer" for="forumStatusSwitch_<?php echo e($subForum->id); ?>">Aktif</label>
                                                        </label>
                                                    </div>
                                                    ...
                                                    <div class="form-group mb-0 mt-1 custom-switches-stacked">
                                                        <label class="custom-switch pl-0 d-flex align-items-center mb-0">
                                                            ...
                                                            <span class="custom-switch-indicator"></span>
                                                            <label class="custom-switch-description mb-0 cursor-pointer" for="forumCloseSwitch_<?php echo e($subForum->id); ?>">Tutup</label>
                                                        </label>
                                                    </div>
                                                </li>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\simpelnakes\resources\views/admin/forums/create.blade.php ENDPATH**/ ?>