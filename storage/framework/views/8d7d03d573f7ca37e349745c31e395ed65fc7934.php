            ...
            <div class="d-flex align-items-center justify-content-between">
                <span class="font-12 text-gray d-block">
                    <?php if(!empty($item->time)): ?>
                        <?php echo e($item->time .' '. ('Minimal')); ?>

                    <?php else: ?>
                        Waktu tidak terbatas
                    <?php endif; ?>

                    <?php echo e(($item->quizQuestions ? ' | ' . $item->quizQuestions->count() .' '. ('Pertanyaan') : '')); ?>
...
<?php /**PATH C:\laragon\www\simpelnakes\resources\views/web/default/course/learningPage/components/quiz_tab/quiz.blade.php ENDPATH**/ ?>