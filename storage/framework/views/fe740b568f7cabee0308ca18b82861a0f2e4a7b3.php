...
<?php $__env->startSection('content'); ?>
    <section class="section">
        <div class="section-header">
            <h1><?php echo e(!empty($filter) ?'Edit': 'Baru'); ?> Filter</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a href="/admin/">Dashboard</a>
                </div>
                <div class="breadcrumb-item active"><a href="/admin/filters">Filter</a>
                </div>
                <div class="breadcrumb-item"><?php echo e(!empty($filter) ?'Edit': 'Baru'); ?></div>
            </div>
        </div>
...
unset($__errorArgs, $__bag); ?>" name="category_id">
                                        <option <?php echo e(!empty($trend) ? '' : 'selected'); ?> disabled>Pilih profesi</option>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\simpelnakes\resources\views/admin/filters/create.blade.php ENDPATH**/ ?>