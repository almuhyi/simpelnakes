...
<?php $__env->startSection('content'); ?>
    <section class="site-top-banner search-top-banner opacity-04 position-relative">
        <img src="<?php echo e(asset($contactSettings['background'])); ?>" class="img-cover" alt="<?php echo e($pageTitle ?? ''); ?>"/>
    ...
    <div class="container">
        ...
        <section class="mt-30 mt-md-50">
            ...
            <form action="<?php echo e(url('/contact/store')); ?>" method="post" class="mt-20">
...
<?php $__env->startPush('scripts_bottom'); ?>
    ...
    <script src="<?php echo e(asset('')); ?>assets/default/js/parts/contact.min.js"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make(getTemplate().'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\simpelnakes\resources\views/web/default/pages/contact.blade.php ENDPATH**/ ?>