<section>
    <h3 class="section-title after-line mt-35">Gambar</h3>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="col-12 col-lg-4">
            <div class="form-group">
                <label class="input-label">Sampul profile</label>
                ...
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input type="text" name="cover_img" id="cover_img" value="<?php echo e(!empty($user) ? $user->cover_img : old('cover_img')); ?>" class="form-control " placeholder="1920x530px lebih disukai"/>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div id="imageCropperContainer">
                    ...
                    <div>
                        <button class="btn btn-transparent" id="cancelAvatarCrop">Batal</button>
                        <button class="btn btn-green" id="storeAvatar">Pilih</button>
                    </div>
...
<?php /**PATH C:\laragon\www\simpelnakes\resources\views/web/default/panel/setting/setting_includes/image.blade.php ENDPATH**/ ?>