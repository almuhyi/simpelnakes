<div id="askNewQuestionModal" class="d-none">
    <div class="custom-modal-body">
        <h2 class="section-title after-line">Pertanyaan baru</h2>

        <form action="<?php echo e(url($course->getForumPageUrl())); ?>/store" class="mt-20">
            ...
            <div class="d-flex align-items-center justify-content-end mt-3">
                <button type="button" class="js-save-question btn btn-sm btn-primary">Buat</button>
                <button type="button" class="close-swl btn btn-sm btn-danger ml-2">Tutup</button>
            </div>
        </form>
    </div>
</div>
<?php /**PATH C:\laragon\www\simpelnakes\resources\views/web/default/course/learningPage/components/forum/ask_question_modal.blade.php ENDPATH**/ ?>