...
<?php $__env->startSection('content'); ?>
    <section>
        <h2 class="section-title">Ringkasan dukungan</h2>
            ...
            <form action="/panel/support/tickets" method="get">
                <div class="row">
                    ...
                    <div class="col-12 col-lg-2 d-flex align-items-center justify-content-end">
                        <button type="submit" class="btn btn-sm font-14 btn-primary w-100 mt-2">Lihat hasil</button>
                    </div>
                </div>
            </form>
        </div>
                    ...
                    <div id="conversationsList" class="col-12 col-lg-6 conversations-list">
                        <div class="table-responsive">
                            <table class="table table-md">
                                <tr>
                                    <th class="text-left font-14 text-gray font-weight-500">Judul</th>
                                    <th class="text-center font-14 text-gray font-weight-500">Tanggal Diperbarui</th>
                                    <th class="text-center font-14 text-gray font-weight-500">Departemen</th>
                                    <th class="text-center font-14 text-gray font-weight-500">Status</th>
                                </tr>
                                <tbody>
                                    ...
                                    <tr class="<?php if(!empty($selectSupport) and $selectSupport->id == $support->id): ?> selected-row <?php endif; ?>">
                                        ...
                                        <td class="text-center align-middle">
                                            <?php if($support->status == 'close'): ?>
                                                <span class="text-danger font-14 font-weight-500">Ditutup</span>
                                            <?php elseif($support->status == 'supporter_replied'): ?>
                                                <span class="text-primary font-14 font-weight-500">Dijawab</span>
                                            <?php else: ?>
                                                <span class="text-warning font-14 font-weight-500">Menunggu</span>
                                            <?php endif; ?>
                                        </td>
                        ...
                        <div class="col-12 col-lg-6 border-left border-gray300">
                            <div class="conversation-box p-15 d-flex align-items-center justify-content-between">
                                <div>
                                    ...
                                    <span class="font-12 text-gray d-block mt-5">Dibuat: <?php echo e(dateTimeFormat($support->created_at,'j M Y | H:i')); ?></span>
                                ...
                                <?php if($selectSupport->status != 'close'): ?>
                                    <a href="/panel/support/<?php echo e($selectSupport->id); ?>/close" class="btn btn-primary btn-sm">Tutup permintaan</a>
                                <?php endif; ?>
                            </div>
...
<?php echo $__env->make(getTemplate() .'.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\simpelnakes\resources\views/web/default/panel/support/ticket_conversations.blade.php ENDPATH**/ ?>