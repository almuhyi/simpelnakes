                        ...
                        <div class="card-body">
                            ...
                            <ul class="nav nav-pills" id="myTab3" role="tablist">
                                <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li class="nav-item">
                                        <a class="nav-link
                                        <?php echo e(($item == $name) ? 'active' : ''); ?>

                                        " href="/admin/settings/personalization/<?php echo e($item); ?>"><?php echo e(trans('admin/main.'.$item)); ?></a>
                                    </li>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\simpelnakes\resources\views/admin/settings/personalization.blade.php ENDPATH**/ ?>