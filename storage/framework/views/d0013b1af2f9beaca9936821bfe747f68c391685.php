        ...
        <div class="panel-collapse">
            ...
            <?php if(!empty($user) and $hasBought): ?>
                <div class="d-flex align-items-center mt-20">
                    <label class="mb-0 mr-10 cursor-pointer font-weight-500" for="fileReadToggle<?php echo e($file->id); ?>">Saya lulus pelajaran ini</label>
                    ...
                    <?php elseif($file->accessibility == 'paid'): ?>
                        <?php if(!empty($user) and $hasBought): ?>
                            <?php if($file->downloadable): ?>
                                <a href="<?php echo e(url($course->getUrl())); ?>/file/<?php echo e($file->id); ?>/download" class="course-content-btns btn btn-sm btn-primary">
                                    Unduh
                                </a>
                            <?php else: ?>
                                <a href="<?php echo e(url($course->getLearningPageUrl())); ?>?type=file&item=<?php echo e($file->id); ?>" target="_blank" class="course-content-btns btn btn-sm btn-primary">
                                    Play
                                </a>
                            <?php endif; ?>
                        <?php else: ?>
                    ...
                    <?php else: ?>
                        ...
                        <?php else: ?>
                            ...
                            <?php elseif($file->storage == 'upload_archive'): ?>
                                <a href="<?php echo e(url('')); ?>/course/<?php echo e($course->slug); ?>/file/<?php echo e($file->id); ?>/showHtml" target="_blank" class="course-content-btns btn btn-sm btn-primary">
                                    Play
                                </a>
                            <?php elseif(in_array($file->storage, ['iframe', 'google_drive', 'dropbox'])): ?>
                                <a href="<?php echo e(url('')); ?>/course/<?php echo e($course->slug); ?>/file/<?php echo e($file->id); ?>/play" target="_blank" class="course-content-btns btn btn-sm btn-primary">
                                    Play
                                </a>
                            ...
                            <?php else: ?>
                                <a href="<?php echo e(url($file->file)); ?>" target="_blank" class="course-content-btns btn btn-sm btn-primary">
                                    Play
                                </a>
                            <?php endif; ?>
                        <?php endif; ?>
...
<?php /**PATH C:\laragon\www\simpelnakes\resources\views/web/default/course/tabs/contents/files.blade.php ENDPATH**/ ?>