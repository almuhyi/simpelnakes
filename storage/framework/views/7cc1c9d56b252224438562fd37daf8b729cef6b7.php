                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select name="sort" data-plugin-selectTwo class="form-control populate">
                                    ...
                                    <option value="have_certificate" <?php if(request()->get('sort') == 'have_certificate'): ?> selected <?php endif; ?>>Kuis dengan sertifikat</option>
                                    <option value="students_count_asc" <?php if(request()->get('sort') == 'students_count_asc'): ?> selected <?php endif; ?>>Peserta ASC</option>
                                    <option value="students_count_desc" <?php if(request()->get('sort') == 'students_count_desc'): ?> selected <?php endif; ?>>Peserta DESC</option>
                                    <option value="passed_count_asc" <?php if(request()->get('sort') == 'passed_count_asc'): ?> selected <?php endif; ?>>Lulus ASC</option>
                                    <option value="passed_count_desc" <?php if(request()->get('sort') == 'passed_count_desc'): ?> selected <?php endif; ?>>Lulus DESC</option>
                                    <option value="grade_avg_asc" <?php if(request()->get('sort') == 'grade_avg_asc'): ?> selected <?php endif; ?>>Nilai rata-rata ASC</option>
                                    <option value="grade_avg_desc" <?php if(request()->get('sort') == 'grade_avg_desc'): ?> selected <?php endif; ?>>Nilai rata-rata DESC</option>
                                    <option value="created_at_asc" <?php if(request()->get('sort') == 'created_at_asc'): ?> selected <?php endif; ?>>Tanggal dibuat ASC</option>
                                    <option value="created_at_desc" <?php if(request()->get('sort') == 'created_at_desc'): ?> selected <?php endif; ?>>Tanggal dibuat DESC</option>
                                </select>
                            </div>
                        </div>
                ...
                <div class="col-12 col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_quizzes_lists_excel')): ?>
                                <div class="text-right">
                                    <a href="/admin/quizzes/excel?<?php echo e(http_build_query(request()->all())); ?>" class="btn btn-primary">Export excel</a>
                                </div>
                            <?php endif; ?>
                                    ...
                                    <?php $__currentLoopData = $quizzes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $quiz): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <span class="d-block text-primary font-12">(Lulus: <?php echo e($quiz->quizResults->where('status','passed')->count()); ?>)</span>
                                            </td>
                                            ...
                                            <td>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_quizzes_results')): ?>
                                                    <a href="/admin/quizzes/<?php echo e($quiz->id); ?>/results" class="btn-transparent btn-sm text-primary" data-toggle="tooltip" title="Hasil">
                                                        <i class="fa fa-poll fa-1x"></i>
                                                    </a>
                                                <?php endif; ?>

                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_quizzes_edit')): ?>
                                                    <a href="/admin/quizzes/<?php echo e($quiz->id); ?>/edit" class="btn-transparent btn-sm text-primary" data-toggle="tooltip" data-placement="top" title="Edit">
                        ...
                        <div class="card-footer text-center">
                            <?php echo e($quizzes->appends(request()->input())->links('vendor.pagination.bootstrap-4')); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\simpelnakes\resources\views/admin/quizzes/lists.blade.php ENDPATH**/ ?>