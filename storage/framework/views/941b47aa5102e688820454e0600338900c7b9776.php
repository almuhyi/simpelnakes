<li data-id="<?php echo e(!empty($chapterItem) ? $chapterItem->id :''); ?>" class="accordion-row bg-white rounded-sm border border-gray300 mt-20 py-15 py-lg-30 px-10 px-lg-20">
    <div class="d-flex align-items-center justify-content-between " role="tab" id="text_lesson_<?php echo e(!empty($textLesson) ? $textLesson->id :'record'); ?>">
        <div class="d-flex align-items-center" href="#collapseTextLesson<?php echo e(!empty($textLesson) ? $textLesson->id :'record'); ?>" aria-controls="collapseTextLesson<?php echo e(!empty($textLesson) ? $textLesson->id :'record'); ?>" data-parent="#chapterContentAccordion<?php echo e(!empty($chapter) ? $chapter->id :''); ?>" role="button" data-toggle="collapse" aria-expanded="true">
            ...
            <div class="font-weight-bold text-dark-blue d-block"><?php echo e(!empty($textLesson) ? $textLesson->title . ($textLesson->accessibility == 'free' ? " (". 'Gratis' .")" : '') : 'Tambahkan pelajaran teks baru'); ?></div>
        </div>
                ...
                <div class="row">
                    <div class="col-12 col-lg-12">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="ajax[<?php echo e(!empty($textLesson) ? $textLesson->id : 'new'); ?>][study_time]" class="js-ajax-study_time form-control" value="<?php echo e(!empty($textLesson) ? $textLesson->study_time : ''); ?>" placeholder="Masukan dengan angka, misalkan 60"/>
                            <div class="invalid-feedback"></div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="js-ajax-attachments <?php if(empty($textLesson)): ?> form-control <?php endif; ?> attachments-select2" multiple="multiple" name="ajax[<?php echo e(!empty($textLesson) ? $textLesson->id : 'new'); ?>][attachments]" data-placeholder="Pilih file terkait sebagai lampiran pelajaran">
                                <option></option>
                    ...
                    <div class="col-12 col-lg-12">
                        ...
                        <?php if(getFeaturesSettings('sequence_content_status')): ?>
                            <div class="form-group mt-20">
                                <div class="d-flex align-items-center justify-content-between">
                                    <label class="cursor-pointer input-label" for="SequenceContentSwitch<?php echo e(!empty($textLesson) ? $textLesson->id : '_record'); ?>">Lanjutan</label>
                                    <div class="custom-control custom-switch">
...
<?php /**PATH C:\laragon\www\simpelnakes\resources\views/web/default/panel/webinar/create_includes/accordions/text-lesson.blade.php ENDPATH**/ ?>