    ...
    <div class="row align-items-center">
        ...
        <div class="col-lg-9 d-block d-md-flex align-items-center justify-content-start my-25 my-lg-0">
            ...
            <div class="d-flex align-items-center justify-content-between justify-content-md-center mx-0 mx-md-20 my-20 my-md-0">
                <label class="mb-0 mr-10 cursor-pointer" for="free_shipping">Gratis pengiriman</label>
                <div class="custom-control custom-switch">
        ...
        <div class="col-lg-3 d-flex align-items-center">
            <select name="sort" class="form-control font-14">
                <option disabled selected>Sortir dengan</option>
                ...
                <option value="best_rates" <?php if(request()->get('sort', null) == 'best_rates'): ?> selected="selected" <?php endif; ?>>Ulasan terbaik</option>
            </select>
        </div>

    </div>
</div>
<?php /**PATH C:\laragon\www\simpelnakes\resources\views/web/default/products/includes/top_filters.blade.php ENDPATH**/ ?>