                                ...
                                <div class="d-flex align-items-center justify-content-between mt-20">
                                    ...
                                    <div class="">
                                        <?php if(!empty($user) and $quiz->can_download_certificate and $hasBought): ?>
                                            <a href="<?php echo e(url('')); ?>/panel/quizzes/results/<?php echo e($quiz->result->id); ?>/showCertificate" target="_blank" class="course-content-btns btn btn-sm btn-primary">Unduh</a>
                                        <?php else: ?>
...
<?php /**PATH C:\laragon\www\simpelnakes\resources\views/web/default/course/tabs/contents/certificate.blade.php ENDPATH**/ ?>