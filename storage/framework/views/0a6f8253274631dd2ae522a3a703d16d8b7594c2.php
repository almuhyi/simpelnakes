...
unset($__errorArgs, $__bag); ?>" data-allow-clear="false" data-search="false">
                        ...
                        <option value="course_support" <?php if($errors->has('webinar_id')): ?> selected <?php endif; ?>>
                            dukungan pelatihan</option>
                        <option value="platform_support" <?php if($errors->has('department_id')): ?> selected <?php endif; ?>>dukungan platform</option>
                    </select>
...
<?php echo $__env->make(getTemplate() .'.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\simpelnakes\resources\views/web/default/panel/support/new.blade.php ENDPATH**/ ?>