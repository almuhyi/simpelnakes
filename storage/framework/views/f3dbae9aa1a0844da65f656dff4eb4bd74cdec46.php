                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="status" data-plugin-selectTwo class="form-control populate">
                                        ...
                                        <option value="success" <?php if(request()->get('status') == 'success'): ?> selected <?php endif; ?>>Berhasil</option>
                                        <option value="refund" <?php if(request()->get('status') == 'refund'): ?> selected <?php endif; ?>>Pengembalian dana</option>
                                        <option value="blocked" <?php if(request()->get('status') == 'blocked'): ?> selected <?php endif; ?>>Akses diblokir</option>
                                    </select>
                                </div>
                            </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\simpelnakes\resources\views/admin/enrollment/history.blade.php ENDPATH**/ ?>