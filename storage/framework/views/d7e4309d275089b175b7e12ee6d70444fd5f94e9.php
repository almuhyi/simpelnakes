<li data-id="<?php echo e(!empty($ticket) ? $ticket->id :''); ?>" class="accordion-row bg-white rounded-sm panel-shadow mt-20 py-15 py-lg-30 px-10 px-lg-20">
    <div class="d-flex align-items-center justify-content-between " role="tab" id="ticket_<?php echo e(!empty($ticket) ? $ticket->id :'record'); ?>">
        <div class="font-weight-bold text-dark-blue" href="#collapseTicket<?php echo e(!empty($ticket) ? $ticket->id :'record'); ?>" aria-controls="collapseTicket<?php echo e(!empty($ticket) ? $ticket->id :'record'); ?>" data-parent="#ticketsAccordion" role="button" data-toggle="collapse" aria-expanded="true">
            <span><?php echo e(!empty($ticket) ? $ticket->title : 'Paket Harga Baru'); ?></span>
        </div>
            ...
            <?php if(!empty($ticket)): ?>
                <div class="btn-group dropdown table-actions mr-15 font-weight-normal">
                    ...
                    <div class="dropdown-menu">
                        <a href="/panel/tickets/<?php echo e($ticket->id); ?>/delete" class="delete-action btn btn-sm btn-transparent">Hapus</a>
                    </div>
                </div>
            <?php endif; ?>
            ...
            <div class="js-content-form ticket-form" data-action="/panel/tickets/<?php echo e(!empty($ticket) ? $ticket->id . '/update' : 'store'); ?>">
                ...
                <div class="row">
                    <div class="col-12 col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="ajax[<?php echo e(!empty($ticket) ? $ticket->id : 'new'); ?>][title]" class="js-ajax-title form-control" value="<?php echo e(!empty($ticket) ? $ticket->title :''); ?>" placeholder="Maksimal 64 karakter"/>
                ...
                <div class="row">
                    <div class="col-12 col-lg-4">
                        ...
                        <div class="form-group">
                            <label class="input-label d-block">Kapasitas</label>
                            <?php if($webinar->isWebinar() and empty($ticket) and !empty($webinar->capacity) and !empty($sumTicketsCapacities)): ?>
                                <span class="test-gray font-12 d-block">
                                    Tetap: <span class="js-ticket-remaining-capacity"><?php echo e($webinar->capacity - $sumTicketsCapacities); ?></span></span>
                            <?php endif; ?>

                            <input type="text" name="ajax[<?php echo e(!empty($ticket) ? $ticket->id : 'new'); ?>][capacity]" class="js-ajax-capacity form-control mt-10" value="<?php echo e(!empty($ticket) ? $ticket->capacity :''); ?>" placeholder="<?php echo e($webinar->isWebinar() ? 'Biarkan kosong untuk menggunakan kapasitas kelas' : 'Biarkan kosong untuk tidak terbatas.'); ?>"/>
                            <div class="invalid-feedback"></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-30 d-flex align-items-center">
                    <button type="button" class="js-save-ticket btn btn-sm btn-primary">Simpan</button>
...
<?php /**PATH C:\laragon\www\simpelnakes\resources\views/web/default/panel/webinar/create_includes/accordions/ticket.blade.php ENDPATH**/ ?>