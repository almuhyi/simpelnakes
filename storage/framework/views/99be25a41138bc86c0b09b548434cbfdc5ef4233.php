            ...
            <div class="row">
                <div class="col-12 col-md-12">
                    <div class="card">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_edit_trending_categories')): ?>
                                                    <a href="/admin/categories/trends/<?php echo e($trend->id); ?>/edit" class="btn-transparent btn-sm text-primary" data-toggle="tooltip" data-placement="top" title="Edit">
                        ...
                        <?php echo e($trends->appends(request()->input())->links('vendor.pagination.bootstrap-4')); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\simpelnakes\resources\views/admin/categories/trends_lists.blade.php ENDPATH**/ ?>