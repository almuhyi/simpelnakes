                                        ...
                                        <td class="text-center align-middle">
                                            <div class="btn-group dropdown table-actions">
                                                ...
                                                <div class="dropdown-menu font-weight-normal">
                                                    <a href="/panel/blog/posts/<?php echo e($post->id); ?>/edit" class="webinar-actions d-block mt-10">Edit</a>
                                                    <a href="/panel/blog/posts/<?php echo e($post->id); ?>/delete" data-item-id="1" class="webinar-actions d-block mt-10 delete-action">Hapus</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
...
<?php echo $__env->make('web.default.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\simpelnakes\resources\views/web/default/panel/blog/posts/lists.blade.php ENDPATH**/ ?>