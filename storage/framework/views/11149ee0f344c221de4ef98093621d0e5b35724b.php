<li data-id="<?php echo e(!empty($chapterItem) ? $chapterItem->id :''); ?>" class="accordion-row bg-white rounded-sm border border-gray300 mt-20 py-15 py-lg-30 px-10 px-lg-20">
    <div class="d-flex align-items-center justify-content-between " role="tab" id="text_lesson_<?php echo e(!empty($textLesson) ? $textLesson->id :'record'); ?>">
        <div class="d-flex align-items-center" href="#collapseTextLesson<?php echo e(!empty($textLesson) ? $textLesson->id :'record'); ?>" aria-controls="collapseTextLesson<?php echo e(!empty($textLesson) ? $textLesson->id :'record'); ?>" data-parent="#chapterContentAccordion<?php echo e(!empty($chapter) ? $chapter->id :''); ?>" role="button" data-toggle="collapse" aria-expanded="true">
            ...
            <div class="font-weight-bold text-dark-blue d-block cursor-pointer"><?php echo e(!empty($textLesson) ? $textLesson->title . ($textLesson->accessibility == 'free' ? " (". 'Gratis' .")" : '') : 'Tambahkan pelajaran teks baru'); ?></div>
        </div>
        ...
        <div class="d-flex align-items-center">
            ...
            <?php if(!empty($textLesson)): ?>
                <a href="<?php echo e(url('')); ?>/admin/text-lesson/<?php echo e($textLesson->id); ?>/delete" class="delete-action btn btn-sm btn-transparent text-gray">
    ...
    <div id="collapseTextLesson<?php echo e(!empty($textLesson) ? $textLesson->id :'record'); ?>" aria-labelledby="text_lesson_<?php echo e(!empty($textLesson) ? $textLesson->id :'record'); ?>" class=" collapse <?php if(empty($textLesson)): ?> show <?php endif; ?>" role="tabpanel">
        <div class="panel-collapse text-gray">
            <div class="js-content-form text_lesson-form" data-action="<?php echo e(url('')); ?>/admin/text-lesson/<?php echo e(!empty($textLesson) ? $textLesson->id . '/update' : 'store'); ?>">
                ...
                <div class="row">
                    <div class="col-12 col-lg-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="ajax[<?php echo e(!empty($textLesson) ? $textLesson->id : 'new'); ?>][study_time]" class="js-ajax-study_time form-control" value="<?php echo e(!empty($textLesson) ? $textLesson->study_time : ''); ?>" placeholder="Masukan angka"/>
                            <div class="invalid-feedback"></div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="d-flex align-items-center js-ajax-accessibility">
                                <div class="custom-control custom-radio">
                                    ...
                                    <label class="custom-control-label font-14 cursor-pointer" for="accessibilityRadio1_<?php echo e(!empty($textLesson) ? $textLesson->id : 'record'); ?>">Gratis</label>
                                </div>
                                ...
                                <div class="custom-control custom-radio ml-15">
                                    ...
                                    <label class="custom-control-label font-14 cursor-pointer" for="accessibilityRadio2_<?php echo e(!empty($textLesson) ? $textLesson->id : 'record'); ?>">Berbayar</label>
                                </div>
                            </div>
                            <div class="invalid-feedback"></div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="js-ajax-attachments <?php if(empty($textLesson)): ?> form-control <?php endif; ?> attachments-select2" name="ajax[<?php echo e(!empty($textLesson) ? $textLesson->id : 'new'); ?>][attachments]" data-placeholder="Pilih lampiran">
                                <option></option>
                    ...
                    <div class="col-12 col-lg-6">
                        <div class="form-group mt-20">
                            <div class="d-flex align-items-center justify-content-between">
                                <label class="cursor-pointer input-label" for="textLessonStatusSwitch<?php echo e(!empty($textLesson) ? $textLesson->id : '_record'); ?>">Aktif</label>
                        ...
                        <?php if(getFeaturesSettings('sequence_content_status')): ?>
                            <div class="form-group mt-20">
                                <div class="d-flex align-items-center justify-content-between">
                                    <label class="cursor-pointer input-label" for="SequenceContentSwitch<?php echo e(!empty($textLesson) ? $textLesson->id : '_record'); ?>">Lainnya</label>
                                    <div class="custom-control custom-switch">
                            ...
                            <div class="js-sequence-content-inputs pl-5 <?php echo e((!empty($textLesson) and ($textLesson->check_previous_parts or !empty($textLesson->access_after_day))) ? '' : 'd-none'); ?>">
                                <div class="form-group">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <label class="cursor-pointer input-label" for="checkPreviousPartsSwitch<?php echo e(!empty($textLesson) ? $textLesson->id : '_record'); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="ajax[<?php echo e(!empty($textLesson) ? $textLesson->id : 'new'); ?>][access_after_day]" value="<?php echo e((!empty($textLesson)) ? $textLesson->access_after_day : ''); ?>" class="js-ajax-access_after_day form-control" placeholder="misalnya 10 untuk mengizinkan peserta mengakses bagian ini setelah 10 hari."/>
                                    <div class="invalid-feedback"></div>
                                </div>
                            </div>
                        <?php endif; ?>
...
<?php /**PATH C:\laragon\www\simpelnakes\resources\views/admin/webinars/create_includes/accordions/text-lesson.blade.php ENDPATH**/ ?>