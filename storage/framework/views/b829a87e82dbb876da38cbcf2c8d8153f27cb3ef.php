...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('')); ?>assets/default/vendors/toast/jquery.toast.min.css">
    <link rel="stylesheet" href="<?php echo e(asset('')); ?>assets/default/vendors/simplebar/simplebar.css">
    <link rel="stylesheet" href="<?php echo e(asset('')); ?>assets/default/css/app.css">

    <?php if($isRtl): ?>
        <link rel="stylesheet" href="<?php echo e(asset('')); ?>assets/default/css/rtl-app.css">
    <?php endif; ?>
...
<!-- Template JS File -->
<script type="text/javascript" src="<?php echo e(asset('')); ?>assets/default/js/app.js"></script>
<script type="text/javascript" src="<?php echo e(asset('')); ?>assets/default/vendors/feather-icons/dist/feather.min.js"></script>
<script type="text/javascript" src="<?php echo e(asset('')); ?>assets/default/vendors/moment.min.js"></script>
<script type="text/javascript" src="<?php echo e(asset('')); ?>assets/default/vendors/sweetalert2/dist/sweetalert2.min.js"></script>
<script type="text/javascript" src="<?php echo e(asset('')); ?>assets/default/vendors/toast/jquery.toast.min.js"></script>
<script type="text/javascript" src="<?php echo e(asset('')); ?>assets/default/vendors/simplebar/simplebar.min.js"></script>
<script type="text/javascript" src="<?php echo e(asset('')); ?>assets/default/vendors/pace-loading/pace.min.js"></script>
...
<script>
    var deleteAlertTitle = '<?php echo e(('Apa kamu yakin?')); ?>';
    var deleteAlertHint = '<?php echo e(('Tindakan ini tidak bisa dibatalkan!')); ?>';
    var deleteAlertConfirm = '<?php echo e(('Hapus')); ?>';
    var deleteAlertCancel = '<?php echo e(('Batalkan')); ?>';
    var deleteAlertSuccess = '<?php echo e(('Berhasil')); ?>';
    var deleteAlertFail = '<?php echo e(('Gagal')); ?>';
    var deleteAlertFailHint = '<?php echo e(('Terjadi kesalahan saat menghapus item!')); ?>';
    var deleteAlertSuccessHint = '<?php echo e(('Item berhasil dihapus.')); ?>';
    var forbiddenRequestToastTitleLang = '<?php echo e(('Permintaan ditolak!')); ?>';
    var forbiddenRequestToastMsgLang = '<?php echo e(('Anda tidak mengakses pelatihan ini.')); ?>';
</script>
...
<script src="<?php echo e(asset('')); ?>assets/default/js/parts/main.min.js"></script>
...
<?php /**PATH C:\laragon\www\simpelnakes\resources\views/web/default/layouts/app.blade.php ENDPATH**/ ?>