...
<?php if(!empty($learningMaterialsExtraDescription) and count($learningMaterialsExtraDescription)): ?>
    <div class="mt-20 rounded-sm border bg-info-light p-15">
        <h3 class="font-16 text-secondary font-weight-bold mb-15">Apa yang akan Anda pelajari?</h3>
...
<?php if($course->description): ?>
    <div class="mt-20">
        <h2 class="section-title after-line">Tentang pelatihan ini</h2>
...
<?php if(!empty($companyLogosExtraDescription) and count($companyLogosExtraDescription)): ?>
    <div class="mt-20 rounded-sm border bg-white p-15">
        <div class="mb-15">
            <h3 class="font-16 text-secondary font-weight-bold">Direkomendasikan oleh perusahaan papan atas</h3>
            <p class="font-14 text-gray mt-5">Perusahaan papan atas menyarankan pelatihan ini kepada karyawan dan staf mereka.</p>
        </div>
        ...
        <div class="row">
            <?php $__currentLoopData = $companyLogosExtraDescription; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $companyLogo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col text-center">
                    <img src="<?php echo e(asset($companyLogo->value)); ?>" class="webinar-extra-description-company-logos" alt="Logo perusahaan">
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    </div>
...
<?php if(!empty($requirementsExtraDescription) and count($requirementsExtraDescription)): ?>
    <div class="mt-20">
        <h3 class="font-16 text-secondary font-weight-bold mb-15">Persyaratan</h3>
...
<?php /**PATH C:\laragon\www\simpelnakes\resources\views/web/default/course/tabs/information.blade.php ENDPATH**/ ?>