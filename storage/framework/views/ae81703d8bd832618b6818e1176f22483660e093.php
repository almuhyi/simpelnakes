...
unset($__errorArgs, $__bag); ?>">
                                        ...
                                        <option value="quiz" <?php echo e((!empty($template) and $template->type == 'quiz') ? 'selected' : ''); ?>>Sertifikat kuis</option>
                                        <option value="course" <?php echo e((!empty($template) and $template->type == 'course') ? 'selected' : ''); ?>>Sertifikat penyelesaian pelatihan</option>
                                    </select>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\simpelnakes\resources\views/admin/certificates/new_templates.blade.php ENDPATH**/ ?>