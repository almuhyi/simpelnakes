<?php $__env->startSection('content'); ?>
    <section class="site-top-banner search-top-banner opacity-04 position-relative">
        <img src="<?php echo e(asset(getPageBackgroundSettings('blog'))); ?>" class="img-cover" alt=""/>

        <div class="container h-100">
            <div class="row h-100 align-items-center justify-content-center text-center">
                <div class="col-12 col-md-9 col-lg-7">
                    <div class="top-search-categories-form">
                        <h1 class="text-white font-30 mb-15">Berita</h1>
                        <span class="course-count-badge py-5 px-10 text-white rounded"><?php echo e($blogCount); ?> Post</span>

                        <div class="search-input bg-white p-10 flex-grow-1">
                            <form action="<?php echo e(url('/blog')); ?>" method="get">
                                <div class="form-group d-flex align-items-center m-0">
                                    <input type="text" name="search" class="form-control border-0" value="<?php echo e(request()->get('search')); ?>" placeholder="Telusuri berita, artikel dan lainnya...."/>
    ...
    <section class="container mt-10 mt-md-40">
        <div class="row">
            ...
            <div class="col-12 col-lg-4">
                ...
                <div class="p-20 mt-30 rounded-sm shadow-lg border border-gray300">
                    <h3 class="category-filter-title font-20 font-weight-bold text-dark-blue">Post populer</h3>
...
<?php echo $__env->make(getTemplate().'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\simpelnakes\resources\views/web/default/blog/index.blade.php ENDPATH**/ ?>