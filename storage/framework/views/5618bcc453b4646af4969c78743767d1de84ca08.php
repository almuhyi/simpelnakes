                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center align-middle">
                                            ...
                                            <?php if(!empty($quiz->userSuccessRate) and $quiz->userSuccessRate > 0): ?>
                                                <span class="font-12 text-primary d-block"><?php echo e($quiz->userSuccessRate); ?>% Lulus</span>
                                            <?php endif; ?>
                                        </td>

                                        <td class="text-center align-middle"><?php echo e($quiz->status); ?></td>
                                        ...
                                        <td class="text-center align-middle">
                                            <div class="btn-group dropdown table-actions">
                                                ...
                                                <div class="dropdown-menu font-weight-normal">
                                                    <a href="/panel/quizzes/<?php echo e($quiz->id); ?>/edit" class="webinar-actions d-block mt-10">Edit</a>
                                                    <a href="/panel/quizzes/<?php echo e($quiz->id); ?>/delete" data-item-id="1" class="webinar-actions d-block mt-10 delete-action">Hapus</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
...
<?php echo $__env->make(getTemplate() .'.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\simpelnakes\resources\views/web/default/panel/quizzes/lists.blade.php ENDPATH**/ ?>