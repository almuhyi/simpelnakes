    ...
    <?php if(!$hasCertificateItem): ?>
        <div class="learning-page-forum-empty d-flex align-items-center justify-content-center flex-column">
            <div class="learning-page-forum-empty-icon d-flex align-items-center justify-content-center">
                <img src="<?php echo e(asset('')); ?>assets/default/img/learning/certificate-empty.svg" class="img-fluid" alt="">
            </div>

            <div class="d-flex align-items-center flex-column mt-10 text-center">
                <h3 class="font-20 font-weight-bold text-dark-blue text-center">Tidak ada Sertifikat!</h3>
                <p class="font-14 font-weight-500 text-gray mt-5 text-center">Pelatihan ini tidak menyertakan sertifikat apa pun</p>
            </div>
        </div>
    <?php endif; ?>
</div>
<?php /**PATH C:\laragon\www\simpelnakes\resources\views/web/default/course/learningPage/components/certificate_tab/index.blade.php ENDPATH**/ ?>