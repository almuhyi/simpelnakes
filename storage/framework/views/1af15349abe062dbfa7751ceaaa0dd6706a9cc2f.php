<div class="add-answer-card mt-4 <?php echo e((empty($answer) or (!empty($loop) and $loop->iteration == 1)) ? 'main-answer-row' : ''); ?>">
    ...
    <div class="row">
        <div class="col-12">
            <div class="form-group">
                <label class="input-label">Jawaban pilihan</label>
    ...
    <div class="row mt-2 align-items-end">
        <div class="col-12 col-md-8">
            <div class="form-group">
                <label class="input-label">Gambar jawaban<span class="braces">(Opsional)</span></label>
        ...
        <div class="col-12 col-md-4">
            <div class="form-group mt-2 d-flex align-items-center justify-content-between js-switch-parent">
                <label class="js-switch" for="correctAnswerSwitch<?php echo e(!empty($answer) ? $answer->id : ''); ?>">
...
<?php /**PATH C:\laragon\www\simpelnakes\resources\views/admin/quizzes/modals/multiple_answer_form.blade.php ENDPATH**/ ?>