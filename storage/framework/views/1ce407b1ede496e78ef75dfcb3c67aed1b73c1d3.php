            ...
            <?php if(!empty($extraDescription)): ?>
                <div class="btn-group dropdown table-actions mr-15">
                    ...
                    <div class="dropdown-menu">
                        <a href="/panel/webinar-extra-description/<?php echo e($extraDescription->id); ?>/delete" class="delete-action btn btn-sm btn-transparent">Hapus</a>
                    </div>
                </div>
            <?php endif; ?>
...
<?php /**PATH C:\laragon\www\simpelnakes\resources\views/web/default/panel/webinar/create_includes/accordions/extra_description.blade.php ENDPATH**/ ?>