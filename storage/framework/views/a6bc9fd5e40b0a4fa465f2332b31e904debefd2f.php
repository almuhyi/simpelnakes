                ...
                <div class="col-12 col-lg-5">
                    ...
                    <form action="/instructor-finder/wizard?<?php echo e(http_build_query(request()->all())); ?>" method="get">
                        ...
                        <div class="mt-50 pt-20 border-top border-gray300 d-flex align-items-center justify-content-end">
                            <a href="<?php echo e(url()->previous()); ?>" class="js-prev-btn btn btn-gray300 btn-sm text-gray <?php echo e(($step == 1) ? 'disabled' : ''); ?>" >Sebelumnya</a>
...
<?php echo $__env->make('web.default.layouts.app',['appFooter' => false], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\simpelnakes\resources\views/web/default/instructorFinder/wizard.blade.php ENDPATH**/ ?>