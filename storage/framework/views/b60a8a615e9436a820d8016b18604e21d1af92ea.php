...
<?php $__env->startSection('content'); ?>
    <section>
        <h2 class="section-title">Statistik hasil</h2>
            ...
            <div class="row">
                <div class="col-6 col-md-3 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <span class="font-16 text-gray font-weight-500">Belum ditinjau</span>
                    </div>
                </div>
                ...
                <div class="col-6 col-md-3 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <span class="font-16 text-gray font-weight-500">Hasil</span>
                    </div>
                </div>
                            ...
                            <div class="row">
                                <div class="col-12 col-lg-7">
                                    <div class="form-group">
                                        ...
                                        <select name="user_id" class="form-control select2" data-placeholder="Semua">
                                            <option value="all">Semua</option>
                                ...
                                <div class="col-12 col-lg-5">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="status" name="status">
                                            <option value="all">Semua</option>
                                            <option value="passed" <?php echo e(request()->get('status','') === "passed" ? 'selected' : ''); ?>>Lulus</option>
                                            <option value="failed" <?php echo e(request()->get('status','') === "failed" ? 'selected' : ''); ?>>Gagal</option>
                                            <option value="waiting" <?php echo e(request()->get('status','') === "waiting" ? 'selected' : ''); ?>>Menunggu</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="d-flex align-items-start align-items-md-center justify-content-between flex-column flex-md-row">
            ...
            <form action="/panel/quizzes/results" method="get" class="">
                <div class="d-flex align-items-center flex-row-reverse flex-md-row justify-content-start justify-content-md-center mt-20 mt-md-0">
                    <label class="mb-0 mr-10 cursor-pointer font-14 text-gray font-weight-500" for="onlyOpenQuizzesSwitch">Hanya tampilkan hasil terbuka</label>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            <?php switch($result->status):
                                                ...
                                                <span class="text-primary">Lulus</span>
                                                <?php break; ?>
                                            ...
                                            <div class="btn-group dropdown table-actions table-actions-lg table-actions-lg">
                                                ...
                                                <div class="dropdown-menu font-weight-normal">
                                                    <?php if($result->status != 'waiting'): ?>
                                                        <a href="/panel/quizzes/<?php echo e($result->id); ?>/result" class="webinar-actions d-block mt-10">Lihat</a>
                                                    <?php endif; ?>

                                                    <?php if($result->status == 'waiting'): ?>
                                                        <a href="/panel/quizzes/<?php echo e($result->id); ?>/edit-result" class="webinar-actions d-block mt-10">Tinjau</a>
                                                    <?php endif; ?>

                                                    <a href="/panel/quizzes/results/<?php echo e($result->id); ?>/delete" class="webinar-actions d-block mt-10 delete-action">Hapus</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
...
<?php echo $__env->make(getTemplate() .'.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\simpelnakes\resources\views/web/default/panel/quizzes/results.blade.php ENDPATH**/ ?>