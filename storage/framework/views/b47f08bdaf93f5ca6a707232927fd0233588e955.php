    ...
    <section>
                ...
                <div class="notification-card rounded-sm panel-shadow bg-white py-15 py-lg-20 px-15 px-lg-40 mt-20">
                    <div class="row align-items-center">
                        ...
                        <div class="col-12 col-lg-4 mt-10 mt-lg-0 text-right">
                            <button type="button" data-id="<?php echo e($notification->id); ?>" id="showNotificationMessage<?php echo e($notification->id); ?>" class="js-show-message btn btn-border-white <?php if(!empty($notification->notificationStatus)): ?> seen-at <?php endif; ?>">Lihat</button>
        ...
        <?php else: ?>
            <?php echo $__env->make(getTemplate() . '.includes.no-result',[
               ...
               'hint' => nl2br(('Setiap notifikasi penting akan muncul disini...')),
...
<?php $__env->startPush('scripts_bottom'); ?>
    ...
    <script src="<?php echo e(asset('')); ?>assets/default/js/panel/notifications.min.js"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make(getTemplate() .'.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\simpelnakes\resources\views/web/default/panel/notifications/index.blade.php ENDPATH**/ ?>