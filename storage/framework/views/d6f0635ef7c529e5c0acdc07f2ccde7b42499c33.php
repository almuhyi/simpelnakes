<div class="product-show-reviews-tab mt-20">
    <div class="course-reviews-box row align-items-center">
        <div class="col-3 col-lg-3 text-center">
            ...
            <div class="text-center">
                ...
                <div class="mt-15"><?php echo e($product->reviews->pluck('creator_id')->count()); ?>  Ulasan</div>
            </div>
        </div>
        ...
        <div class="col-9 col-lg-6">
            <div class="d-flex align-items-center">
                ...
                <span class="ml-15 font-14 text-gray text-left">Produk (<?php echo e($product->reviews->count() > 0 ? round($product->reviews->avg('product_quality'), 1) : 0); ?>)</span>
            </div>
            ...
            <div class="mt-25 d-flex align-items-center">
                ...
                <span class="ml-15 font-14 text-gray text-left">nilai pembelian (<?php echo e($product->reviews->count() > 0 ? round($product->reviews->avg('purchase_worth'), 1) : 0); ?>)</span>
            </div>
            ...
            <div class="mt-25 d-flex align-items-center">
                ...
                <span class="ml-15 font-14 text-gray text-left">Pengiriman (<?php echo e($product->reviews->count() > 0 ? round($product->reviews->avg('delivery_quality'), 1) : 0); ?>)</span>
            </div>
            ...
            <div class="mt-25 d-flex align-items-center">
                ...
                <span class="ml-15 font-14 text-gray text-left">Penjual (<?php echo e($product->reviews->count() > 0 ? round($product->reviews->avg('seller_quality'), 1) : 0); ?>)</span>
            </div>
    ...
    <section class="mt-40">
        <h2 class="section-title after-line">Ulasan (<?php echo e($product->reviews->pluck('creator_id')->count()); ?>)</h2>
        ...
        <form action="/products/reviews/store" class="mt-20" method="post">
            ...
            <div class="reviews-stars row align-items-center">
                ...
                <div class="col-6 col-md-3 d-flex flex-column align-items-center justify-content-center barrating-stars">
                    <span class="font-14 text-gray">Produk</span>
                ...
                <div class="col-6 col-md-3 d-flex flex-column align-items-center justify-content-center barrating-stars">
                    <span class="font-14 text-gray">Pengiriman</span>
                ...
                <div class="col-6 col-md-3 d-flex flex-column align-items-center justify-content-center barrating-stars">
                    <span class="font-14 text-gray">Penjual</span>
            ...
            <button type="submit" class="btn btn-sm btn-primary mt-20">Post ulasan</button>
        </form>
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="btn-group dropdown table-actions">
                                    ...
                                    <div class="dropdown-menu">
                                        <a href="/products/reviews/store-reply-comment" class="webinar-actions d-block text-hover-primary reply-comment">Balas</a>

                                        <?php if(!empty($authUser) and $authUser->id == $review->creator_id): ?>
                                            <a href="/products/reviews/<?php echo e($review->id); ?>/delete" class="delete-action d-block mt-10 text-hover-primary">Hapus</a>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div class="btn-group dropdown table-actions">
                                                ...
                                                <div class="dropdown-menu">
                                                    ...
                                                    <?php if(!empty($authUser) and $authUser->id == $comment->user_id): ?>
                                                        <a href="/comments/<?php echo e($comment->id); ?>/delete" class="webinar-actions d-block mt-10 text-hover-primary">Hapus</a>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                        </div>
...
<?php /**PATH C:\laragon\www\simpelnakes\resources\views/web/default/products/includes/tabs/reviews.blade.php ENDPATH**/ ?>