                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="status" data-plugin-selectTwo class="form-control populate">
                                        ...
                                        <option value="pending" <?php if(request()->get('status') == 'pending'): ?> selected <?php endif; ?>>Draft</option>
                                        <option value="publish" <?php if(request()->get('status') == 'publish'): ?> selected <?php endif; ?>>Publish</option>
                                    </select>
                                </div>
                            </div>
                ...
                <div class="col-12 col-md-12">
                    <div class="card">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="text-<?php echo e(($post->status == 'pending') ? 'warning' : 'success'); ?>">
                                                    <?php echo e(($post->status == 'pending') ? 'Tertunda' : 'Dipublish'); ?>
                                            ...
                                            <td width="150px">
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_blog_edit')): ?>
                                                    <a href="/admin/blog/<?php echo e($post->id); ?>/edit" class="btn-transparent text-primary" data-toggle="tooltip" data-placement="top" title="Edit">
                        ...
                        <div class="card-footer text-center">
                            <?php echo e($blog->appends(request()->input())->links('vendor.pagination.bootstrap-4')); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\simpelnakes\resources\views/admin/blog/lists.blade.php ENDPATH**/ ?>