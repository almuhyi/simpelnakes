                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-12 col-md-6">
                                    <form action="/admin/recommended-topics/<?php echo e(!empty($recommended) ? $recommended->id.'/update' : 'store'); ?>" method="post">
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="icon" id="icon" value="<?php echo e((!empty($recommended)) ? $recommended->icon : old('icon')); ?>" class="form-control <?php $__errorArgs = ['icon'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\simpelnakes\resources\views/admin/forums/recommended_topics/create.blade.php ENDPATH**/ ?>