    ...
    <div class="pick-a-time d-none" id="PickTimeContainer" data-user-id="<?php echo e($user["id"]); ?>">
        ...
        <div class="d-flex align-items-center my-40 rounded-lg border px-10 py-5">
            <div class="appointment-timezone-icon">
                <img src="<?php echo e(asset('')); ?>assets/default/img/icons/timezone.svg" alt="appointment timezone">
            </div>
            <div class="ml-15">
                <div class="font-16 font-weight-bold text-dark-blue">Catatan:</div>
                <p class="font-14 font-weight-500 text-gray"> Semua slot waktu ditampilkan dalam zona waktu <?php echo e($meetingTimezone .' '. toGmtOffset($meetingTimezone)); ?></p>
            </div>
        </div>


        <div class="loading-img d-none text-center">
            <img src="<?php echo e(asset('')); ?>assets/default/img/loading.gif" width="80" height="80">
        </div>

        <form action="<?php echo e(url((!$meeting->disabled) ? '/meetings/reserve' : '')); ?>" method="post" id="PickTimeBody" class="d-none">
            ...
            <h3 class="font-16 font-weight-bold text-dark-blue">
                ...
                <?php else: ?>
                    ...
                    <?php if(!empty($meeting) and !empty($meeting->discount) and !empty($meeting->amount) and $meeting->amount > 0): ?>
                        <span class="badge badge-danger text-white font-12"><?php echo e($meeting->discount); ?>% Off</span>
                    <?php endif; ?>
                <?php endif; ?>
            </h3>
            ...
            <div class="d-flex flex-column mt-10">
                ...
                <?php else: ?>
                  ...
                  <?php if($meeting->group_meeting): ?>
                    <span class="d-block font-14 text-gray font-weight-500">Instruktur ini dapat melakukan pertemuan kelompok dengan peserta minimal <?php echo e($meeting->online_group_min_student, $meeting->online_group_max_student); ?> peserta</span>
                  <?php endif; ?>
                    ...
                    <?php if($meeting->group_meeting): ?>
                        ...
                        <div class="js-group-meeting-options d-none mt-15">
                            ...
                            <div class="js-online-group-amount d-none font-14 font-weight-500 mt-15">
                                <span class="text-gray d-block">Tarif per jam pertemuan grup secara online adalah <?php echo e(addCurrencyToPrice($meeting->online_group_amount)); ?> per peserta</span>
                                <span class="text-danger mt-5 d-block">Kapasitas pertemuan kelompok minimal adalah <?php echo e($meeting->online_group_min_student, $meeting->online_group_max_student); ?> peserta.</span>
                                <span class="text-danger mt-5 d-block">Kapasitas pertemuan kelompok maksimum adalah <?php echo e($meeting->online_group_max_student); ?> peserta.</span>
                            </div>

                            <?php if($meeting->in_person): ?>
                            <div class="js-in-person-group-amount d-none font-14 font-weight-500 mt-15">
                                <span class="text-gray d-block">Tarif per jam untuk pertemuan grup secara tatap muka adalah <?php echo e(addCurrencyToPrice($meeting->in_person_group_amount)); ?> per peserta</span>
                                <span class="text-danger mt-5 d-block">Kapasitas pertemuan kelompok minimal adalah <?php echo e($meeting->in_person_group_min_student, $meeting->in_person_group_max_student); ?> peserta.</span>
                                <span class="text-danger mt-5 d-block">Kapasitas pertemuan kelompok maksimum adalah <?php echo e($meeting->in_person_group_max_student); ?> peserta.</span>
                            </div>
                            <?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\simpelnakes\resources\views/web/default/user/profile_tabs/appointments.blade.php ENDPATH**/ ?>