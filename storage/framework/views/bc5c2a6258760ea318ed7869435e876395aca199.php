...
<?php $__env->startSection('content'); ?>
    <section class="section">
        <div class="section-header">
            <h1><?php echo e(!empty($role) ?'Edit': 'Baru'); ?> Role</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a href="/admin/">Dashboard</a>
                </div>
                <div class="breadcrumb-item active"><a href="/admin/roles">Role</a>
                </div>
                <div class="breadcrumb-item"><?php echo e(!empty($role) ?'Edit': 'Baru'); ?></div>
            </div>
        </div>
        <?php if($errors->any()): ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\simpelnakes\resources\views/admin/roles/create.blade.php ENDPATH**/ ?>