        ...
        <div class="panel-collapse">
            <div class="d-flex align-items-center mt-20">
                <div class="d-flex align-items-center text-gray text-center font-14 mr-20">
                    ...
                    <span class="line-height-1"><?php echo e($quiz->quizQuestions->count()); ?> Pertanyaan</span>
                </div>

                <div class="d-flex align-items-center text-gray text-center font-14 mr-20">
                    <i data-feather="clock" width="18" height="18" class="text-gray mr-5"></i>
                    <span class="line-height-1"><?php echo e($quiz->time); ?> Menit</span>
                </div>

                <div class="d-flex align-items-center text-gray text-center font-14 mr-20">
                    <i data-feather="check-square" width="18" height="18" class="text-gray mr-5"></i>
                    <span class="line-height-1">Nilai lulus: <?php echo e($quiz->pass_mark); ?>/<?php echo e($quiz->quizQuestions->sum('grade')); ?></span>
                </div>

                <div class="d-flex align-items-center text-gray text-center font-14 mr-20">
                    <i data-feather="check-square" width="18" height="18" class="text-gray mr-5"></i>
                    <span class="line-height-1">Percobaan: <?php echo e((!empty($user) and !empty($quiz->result_count)) ? $quiz->result_count : '0'); ?>/<?php echo e($quiz->attempt); ?></span>
                </div>
            ...
            <div class="d-flex justify-content-end mt-20">
                <?php if(!empty($user) and $quiz->can_try and $hasBought): ?>
                    <a href="<?php echo e(url('')); ?>/panel/quizzes/<?php echo e($quiz->id); ?>/start" class="course-content-btns btn btn-sm btn-primary">Mulai kuis</a>
                <?php else: ?>
...
<?php /**PATH C:\laragon\www\simpelnakes\resources\views/web/default/course/tabs/contents/quiz.blade.php ENDPATH**/ ?>