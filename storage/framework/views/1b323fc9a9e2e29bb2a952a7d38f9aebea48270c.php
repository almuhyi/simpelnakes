...
<?php if(!empty($quizzes) and $quizzes->count() > 0): ?>
    <section class="mt-20">
        <h2 class="section-title after-line">Kuis & Sertifikat</h2>
        <div class="row">
            <div class="col-12">
...
<?php /**PATH C:\laragon\www\simpelnakes\resources\views/web/default/course/tabs/content.blade.php ENDPATH**/ ?>