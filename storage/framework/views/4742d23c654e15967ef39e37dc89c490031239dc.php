...
<?php $__env->startSection('content'); ?>
    ...
    <section class="mt-35">
        <div class="d-flex align-items-start align-items-md-center justify-content-between flex-column flex-md-row">
            <h2 class="section-title">Kuis saya</h2>
                                    ...
                                    <tr>
                                        ...
                                        <span class="d-block text-<?php echo e(($result->status == 'passed') ? 'primary' : ($result->status == 'waiting' ? 'warning' : 'danger')); ?>">
                                            ...
                                            <?php if($result->status =='failed' and $result->can_try): ?>
                                                <span class="d-block font-12 text-gray"><?php echo e($result->count_can_try); ?> Kesempatan lagi</span>
                                            <?php endif; ?>
                                        </td>
                                            ...
                                            <div class="btn-group dropdown table-actions table-actions-lg table-actions-lg">
                                                ...
                                                <div class="dropdown-menu">
                                                    <?php if(!$result->can_try and $result->status != 'waiting'): ?>
                                                        <a href="/panel/quizzes/<?php echo e($result->id); ?>/result" class="webinar-actions d-block mt-10">Lihat jawaban</a>
                                                    <?php endif; ?>

                                                    <?php if($result->status != 'passed'): ?>
                                                        <?php if($result->can_try): ?>
                                                            <a href="/panel/quizzes/<?php echo e($result->quiz->id); ?>/start" class="webinar-actions d-block mt-10">Coba lagi</a>
                                                        <?php endif; ?>
                                                    <?php endif; ?>

                                                    <a href="<?php echo e($result->quiz->webinar->getUrl()); ?>" class="webinar-actions d-block mt-10">Halaman pelatihan</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
...
<?php echo $__env->make(getTemplate() .'.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\simpelnakes\resources\views/web/default/panel/quizzes/my_results.blade.php ENDPATH**/ ?>