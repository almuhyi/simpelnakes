<div class="product-show-seller-tab mt-20">
    ...
    <?php if(!empty($seller->about)): ?>
        <div class="mt-40">
            <h3 class="font-16 text-dark-blue font-weight-bold">Tentang profil</h3>
...
<?php /**PATH C:\laragon\www\simpelnakes\resources\views/web/default/products/includes/tabs/seller.blade.php ENDPATH**/ ?>