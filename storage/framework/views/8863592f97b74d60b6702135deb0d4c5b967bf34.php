            ...
            <div class="row">
                ...
                <div class="col-6 col-md-3 d-flex align-items-center justify-content-center mt-5 mt-md-0">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <strong class="font-30 font-weight-bold mt-5 text-dark-blue"><?php echo e(!empty($totalPurchase) ? addCurrencyToPrice($totalPurchase) : 0); ?></strong>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            <?php if(!empty($order->sale->discount) and (int)$order->sale->discount > 0): ?>
                                                <?php echo e(addCurrencyToPrice(handlePriceFormat($order->sale->discount) ?? 0)); ?>
                                        ...
                                        <td class="align-middle">
                                            <?php if(!empty($order->sale->tax)): ?>
                                                <?php echo e(addCurrencyToPrice($order->sale->tax)); ?>
                                        ...
                                        <td class="align-middle">
                                            <?php if(!empty($order->sale->product_delivery_fee)): ?>
                                                <?php echo e(addCurrencyToPrice($order->sale->product_delivery_fee)); ?>
...
<?php echo $__env->make(getTemplate() .'.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\simpelnakes\resources\views/web/default/panel/store/my-purchases.blade.php ENDPATH**/ ?>