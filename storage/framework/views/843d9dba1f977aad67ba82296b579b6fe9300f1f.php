...
<div class="learning-content" id="learningPageContent">
    ...
    <div class="learning-content-loading align-items-center justify-content-center flex-column w-100 h-100 <?php echo e($showLoading ? 'd-flex' : 'd-none'); ?>">
        <img src="<?php echo e(asset('')); ?>assets/default/img/loading.gif" alt="">
        <p class="mt-10">Harap tunggu hingga konten materi dimuat</p>
    </div>
</div>
<?php /**PATH C:\laragon\www\simpelnakes\resources\views/web/default/course/learningPage/components/content.blade.php ENDPATH**/ ?>