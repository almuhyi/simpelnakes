    ...
    <figure>
        <div class="image-box">
            <a href="<?php echo e($product->getUrl()); ?>" class="image-box__a">
                ...
                <span class="badge badge-danger">Diskon <?php echo e($hasDiscount->percent); ?>%</span>
                <?php elseif($product->isPhysical() and empty($product->delivery_fee)): ?>
                    <span class="badge badge-warning">Gratis pengiriman</span>
                <?php endif; ?>
        ...
        <figcaption class="product-card-body">
            ...
            <?php if(!empty($product->category)): ?>
                <span class="d-block font-14 mt-10">Kategori <a href="/products?category_id=<?php echo e($product->category->id); ?>" target="_blank" class="text-decoration-underline"><?php echo e($product->category->title); ?></a></span>
            <?php endif; ?>
            ...
            <div class="product-price-box mt-25">
                <?php if(!empty($isRewardProducts) and !empty($product->point)): ?>
                    <span class="text-warning real font-14"><?php echo e($product->point); ?> Poin</span>
...
<?php /**PATH C:\laragon\www\simpelnakes\resources\views/web/default/products/includes/card.blade.php ENDPATH**/ ?>