            ...
            <div class="row h-100 align-items-center justify-content-center text-center">
                <div class="col-12 col-md-9 col-lg-7">
                    <div class="top-search-categories-form">
                        <h1 class="text-white font-30 mb-15">Produk</h1>
                        <span class="course-count-badge py-5 px-10 text-white rounded"><?php echo e($productsCount); ?> Produk</span>
                        ...
                        <div class="search-input bg-white p-10 flex-grow-1">
                            <form action="<?php echo e((!empty($isRewardProducts) and $isRewardProducts) ? '/reward-products' : '/products'); ?>" method="get">
                                <div class="form-group d-flex align-items-center m-0">
                                    <input type="text" name="search" class="form-control border-0" placeholder="Cari produk di toko"/>
...
<?php echo $__env->make('web.default.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\simpelnakes\resources\views/web/default/products/search.blade.php ENDPATH**/ ?>