...
<?php $__env->startSection('content'); ?>
    <section class="section">
        <div class="section-header">
            <h1><?php echo e(!empty($category) ?'Edit': 'Baru'); ?> Kategori Profesi</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a href="/admin/">Dashboard</a>
                </div>
                <div class="breadcrumb-item active">
                    <a href="/admin/categories">Kategori profesi</a>
                </div>
                <div class="breadcrumb-item"><?php echo e(!empty($category) ?'Edit': 'Baru'); ?></div>
            </div>
        </div>
                                                ...
                                                <li class="form-group list-group">
                                                    ...
                                                    <div class="p-2 border rounded-sm">
                                                        ...
                                                        <div class="input-group mt-1">
                                                            ...
                                                            <input type="text" name="sub_categories[<?php echo e($subCategory->id); ?>][icon]" id="icon_<?php echo e($subCategory->id); ?>" class="form-control" value="<?php echo e($subCategory->icon); ?>" placeholder="Icon"/>
                                                        </div>
                                                    </div>
                                                </li>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\simpelnakes\resources\views/admin/categories/create.blade.php ENDPATH**/ ?>