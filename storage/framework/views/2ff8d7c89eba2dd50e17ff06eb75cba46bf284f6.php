            ...
            <div class="col-12 col-lg-8">
                <div class="course-content-body user-select-none">
                    <div class="course-body-on-cover text-white">
                        ...
                        <span class="d-block font-16 mt-10">Kategori <a href="<?php echo e($bundle->category->getUrl()); ?>" target="_blank" class="font-weight-500 text-decoration-underline text-white"><?php echo e($bundle->category->title); ?></a></span>
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <span class="ml-10 mt-15 font-14">(<?php echo e($bundle->reviews->pluck('creator_id')->count()); ?> Ulasan)</span>
                        </div>
                        ...
                        <ul class="nav nav-tabs bg-secondary rounded-sm p-15 d-flex align-items-center justify-content-between" id="tabs-tab" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="position-relative font-14 text-white <?php echo e((request()->get('tab','') == 'content') ? 'active' : ''); ?>" id="content-tab" data-toggle="tab"
                                   ...
                                   aria-selected="false">Materi (<?php echo e($bundle->bundleWebinars->count()); ?>)</a>
                            </li>
                            <li class="nav-item">
                                <a class="position-relative font-14 text-white <?php echo e((request()->get('tab','') == 'reviews') ? 'active' : ''); ?>" id="reviews-tab" data-toggle="tab"
                                   ...
                                   aria-selected="false">Ulasan (<?php echo e($bundle->reviews->count() > 0 ? $bundle->reviews->pluck('creator_id')->count() : 0); ?>)</a>
                            </li>
                        </ul>
                            ...
                            <div class="mt-20 d-flex flex-column">
                                ...
                                <?php elseif($bundle->price > 0): ?>
                                    ...
                                    <?php if($canSale and $bundle->subscribe): ?>
                                        <a href="/subscribes/apply/bundle/<?php echo e($bundle->slug); ?>" class="btn btn-outline-primary btn-subscribe mt-20 <?php if(!$canSale): ?> disabled <?php endif; ?>">Langganan</a>
                                    <?php endif; ?>
                                    ...
                                    <?php if($canSale and !empty($bundle->points)): ?>
                                        <a href="<?php echo e(!(auth()->check()) ? '/login' : '#'); ?>" class="<?php echo e((auth()->check()) ? 'js-buy-with-point' : ''); ?> btn btn-outline-warning mt-20 <?php echo e((!$canSale) ? 'disabled' : ''); ?>" rel="nofollow">
                                            Beli dengan <?php echo $bundle->points; ?> point
                                        </a>
                                    <?php endif; ?>
                                <?php else: ?>
                                    <a href="<?php echo e($canSale ? '/bundles/'. $bundle->slug .'/free' : '#'); ?>" class="btn btn-primary <?php if(!$canSale): ?> disabled <?php endif; ?>">Beli paket pelatihan</a>
                                <?php endif; ?>
                            </div>
                ...
                <div class="rounded-lg shadow-sm mt-35 px-25 py-20">
                    ...
                    <div class="mt-30">
                        <div class="mt-20 d-flex align-items-center justify-content-between text-gray">
                            ...
                            <span class="font-14"><?php echo e(convertMinutesToHourAndMinute($bundle->getBundleDuration())); ?> Jam</span>
                        </div>
                        ...
                        <?php if(!empty($bundle->access_days)): ?>
                            <div class="mt-20 d-flex align-items-center justify-content-between text-gray">
                                ...
                                <span class="font-14"><?php echo e($bundle->access_days); ?> Hari</span>
                            </div>
                        <?php endif; ?>
...
<?php $__env->startPush('scripts_bottom'); ?>
    ...
    <script>
        ...
        var notLoginToastMsgLang = '<?php echo e(('Silahkan masuk untuk mengakses konten.')); ?>';
...
<?php echo $__env->make(getTemplate().'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\simpelnakes\resources\views/web/default/bundle/index.blade.php ENDPATH**/ ?>