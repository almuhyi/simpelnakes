<div class="blog-grid-card">
    <div class="blog-grid-image">
        <img src="<?php echo e(asset($post->image)); ?>" class="img-cover" alt="<?php echo e($post->title); ?>">
    ...
    <div class="blog-grid-detail">
        <a href="<?php echo e(url($post->getUrl())); ?>">
...
<?php /**PATH C:\laragon\www\simpelnakes\resources\views/web/default/blog/grid-list.blade.php ENDPATH**/ ?>