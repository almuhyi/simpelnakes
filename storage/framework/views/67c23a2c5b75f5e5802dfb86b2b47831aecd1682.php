            ...
            <div class="col-12 col-lg-6 mt-20 mt-lg-0">
                <form action="/cart/store" method="post" id="productAddToCartForm">
                    ...
                    <div class="product-show-info-card bg-info p-15 p-md-25 rounded-lg">
                        ...
                        <span class="d-block font-16 mt-10">Kategori <a href="<?php echo e($product->category->getUrl()); ?>" target="_blank" class="font-weight-500 text-decoration-underline"><?php echo e($product->category->title); ?></a></span>
                        ...
                        <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-md-between mt-20">
                            <div class="d-flex align-items-center">
                                ...
                                <span class="ml-10 font-14">(<?php echo e($product->reviews->pluck('creator_id')->count()); ?> Ulasan)</span>
                            </div>

                            <div class="d-flex align-items-center mt-15 mt-md-0">
                                <span class="mr-5">Ketersediaan</span>
                                <?php if(($product->getAvailability() > 0)): ?>
                                    <?php if(!empty($product->inventory) and !empty($product->inventory_warning) and $product->inventory_warning > $product->getAvailability()): ?>
                                        <span class="product-availability-badge badge-warning">
                                         Hanya tersisa <?php echo e($product->getAvailability()); ?>!</span>
                                    <?php else: ?>
                                        <span class="product-availability-badge badge-primary">Stok tersedia</span>
                                    <?php endif; ?>
                                <?php else: ?>
                                    <span class="product-availability-badge badge-danger">Stok habis</span>
                                <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="product-show-price-box mt-15">
                            ...
                            <?php if(!empty($product->delivery_fee) and $product->delivery_fee > 0): ?>
                                <span class="shipping-price d-block mt-5">+ <?php echo e(handlePrice($product->delivery_fee)); ?> Pengiriman</span>
                            <?php else: ?>
                                <span class="text-warning d-block font-14 font-weight-500 mt-5">Gratis pengiriman</span>
                            <?php endif; ?>
                        </div>
                        ...
                        <div class="product-show-cart-actions d-flex align-items-center flex-wrap ">
                            ...
                            <div class="d-flex flex-column flex-md-row align-items-md-center w-100 mt-20">
                                <button type="submit" class="btn <?php echo e(($product->getAvailability() > 0) ? 'btn-primary' : 'btn-dark'); ?>" <?php echo e(($product->getAvailability() < 1) ? 'disabled' : ''); ?>>
                                    ...
                                    <?php echo e(($product->getAvailability() > 0) ? ('Tambah ke keranjang') : ('Stok Habis')); ?>
                                ...
                                <?php if($product->getAvailability() > 0 and !empty($product->point) and $product->point > 0): ?>
                                    ...
                                    <a href="<?php echo e(!(auth()->check()) ? '/login' : '#!'); ?>" class="<?php echo e((auth()->check()) ? 'js-buy-with-point' : ''); ?> js-buy-with-point-show-btn btn btn-outline-warning mt-10 mt-md-0 ml-0 ml-md-10" rel="nofollow">
                                        Beli dengan <?php echo $product->point; ?> poin
                                    </a>
                                <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="d-flex flex-column flex-md-row align-items-md-center w-100 mt-35">
                            <?php if($product->isPhysical() and !empty($product->delivery_estimated_time)): ?>
                                <div class="product-show-info-footer-items d-flex align-items-center mb-10 mb-md-0 mr-0 mr-md-10">
                                    ...
                                    <div class="ml-5">
                                        <span class="d-block font-14 font-weight-bold text-dark">Produk Fisik</span>
                                        <span class="d-block font-12 text-gray">Barang ini akan dikirim estimasi <?php echo e($product->delivery_estimated_time); ?> hari</span>
                                    </div>
                                </div>
                            <?php elseif($product->isVirtual()): ?>
                                <div class="product-show-info-footer-items d-flex align-items-center mb-10 mb-md-0 mr-0 mr-md-10">
                                    ...
                                    <div class="ml-5">
                                        <span class="d-block font-14 font-weight-bold text-dark">Produk Virtual</span>
                                        <span class="d-block font-12 text-gray">
                                            Unduh semua file setelah pembayaran.</span>
                                    </div>
                                </div>
                            <?php endif; ?>
                            ...
                            <div class="js-share-product product-show-info-footer-items d-flex align-items-center cursor-pointer">
                                ...
                                <div class="ml-5">
                                    <span class="d-block font-14 font-weight-bold text-dark">Bagikan</span>
                                    <span class="d-block font-12 text-gray">Produk ini dengan teman-teman Anda!</span>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php $__env->startPush('scripts_bottom'); ?>
    <script>
        ...
        var reportSuccessLang = '<?php echo e(('Laporan berhasil dikirim')); ?>';
        var reportFailLang = '<?php echo e(('Laporan gagal. Pastikan Anda sudah masuk.')); ?>';
        var messageToReviewerLang = '<?php echo e(('Kirim pesan ke peninjau')); ?>';
        var unFollowLang = '<?php echo e(('Berhenti mengikuti')); ?>';
        var followLang = '<?php echo e(('Ikuti')); ?>';
        var messageSuccessSentLang = '<?php echo e(('Pesan berhasil terkirim')); ?>';
        var productDemoLang = '<?php echo e(('Demo Produk')); ?>';
        var onlineViewerModalTitleLang = '<?php echo e(('Penampil daring')); ?>';
    </script>
...
<?php echo $__env->make('web.default.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\simpelnakes\resources\views/web/default/products/show.blade.php ENDPATH**/ ?>