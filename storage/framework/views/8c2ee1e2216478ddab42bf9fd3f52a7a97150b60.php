                            ...
                            <table class="table text-center custom-table">
                                ...
                                <?php $__currentLoopData = \App\Models\MeetingTime::$days; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr id="<?php echo e($day); ?>TimeSheet" data-day="<?php echo e($day); ?>">
                                        <td class="text-left">
                                            <span class="font-weight-500 text-dark-blue d-block"><?php echo e($day); ?></span>
                                            <span class="font-12 text-gray"><?php echo e(isset($meetingTimes[$day]) ? $meetingTimes[$day]["hours_available"] : 0); ?> <?php echo e('Jam' .' '. 'Tersedia'); ?></span>
                                        </td>
                                                ...
                                                <?php $__currentLoopData = $meetingTimes[$day]["times"]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $time): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="position-relative selected-time px-15 py-5 mb-10 mb-lg-0 bg-gray200 rounded d-inline-block mr-10">
                                                        <span class="inner-time text-gray font-12">
                                                            ...
                                                            <span class="font-12 text-gray"><?php echo e($time->meeting_type == 'all' ? 'keduanya' : $time->meeting_type); ?></span>
                                                        </span>
            ...
            <div class="row align-items-center mt-20">
                ...
                <div class="col-12 col-md-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" name="amount" value="<?php echo e(!empty($meeting) ? $meeting->amount : old('amount')); ?>" class="form-control" placeholder="Masukan angka"/>
                ...
                <div class="col-12 col-md-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" name="discount" value="<?php echo e(!empty($meeting) ? $meeting->discount : old('discount')); ?>" class="form-control" placeholder="Masukan angka"/>
                        <div class="invalid-feedback"></div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-3 <?php echo e(((!empty($meeting) and $meeting->in_person) or old('in_person') == 'on') ? '' :  'd-none'); ?>" id="inPersonMeetingAmount">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" name="in_person_amount" value="<?php echo e(!empty($meeting) ? $meeting->in_person_amount : old('in_person_amount')); ?>" class="form-control" placeholder="Masukan angka"/>
                        <div class="invalid-feedback"></div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-12 mt-5 <?php echo e(((!empty($meeting) and $meeting->group_meeting) or old('group_meeting') == 'on') ? '' :  'd-none'); ?>" id="onlineGroupMeetingOptions">
                    ...
                    <div class="row mt-15">
                        <div class="col-12 col-lg-3">
                            ...
                            <input type="number" min="2" name="online_group_min_student" value="<?php echo e(!empty($meeting) ? $meeting->online_group_min_student : old('online_group_min_student')); ?>" class="form-control" placeholder="Masukan angka"/>
                            <div class="invalid-feedback"></div>
                        </div>

                        <div class="col-12 col-lg-3">
                            <label class="font-weight-500 font-14 text-dark-blue d-block">Maksimal peserta</label>
                            <input type="number" name="online_group_max_student" value="<?php echo e(!empty($meeting) ? $meeting->online_group_max_student : old('online_group_max_student')); ?>" class="form-control" placeholder="Masukan angka"/>
                            <div class="invalid-feedback"></div>
                        </div>
                        ...
                        <div class="col-12 col-lg-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="online_group_amount" value="<?php echo e(!empty($meeting) ? $meeting->online_group_amount : old('online_group_amount')); ?>" class="form-control" placeholder="Masukan angka"/>
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-12 mt-20 <?php echo e(((!empty($meeting) and $meeting->group_meeting and $meeting->in_person) or (old('group_meeting') == 'on' and old('in_person') == 'on')) ? '' :  'd-none'); ?>" id="inPersonGroupMeetingOptions">
                    ...
                    <div class="row mt-15">
                        <div class="col-12 col-lg-3">
                            <label class="font-weight-500 font-14 text-dark-blue d-block">Minimal peserta</label>
                            <input type="number" min="2" name="in_person_group_min_student" value="<?php echo e(!empty($meeting) ? $meeting->in_person_group_min_student : old('in_person_group_min_student')); ?>" class="form-control" placeholder="Masukan angka"/>
                            <div class="invalid-feedback"></div>
                        </div>

                        <div class="col-12 col-lg-3">
                            <label class="font-weight-500 font-14 text-dark-blue d-block">Maksimal peserta</label>
                            <input type="number" name="in_person_group_max_student" value="<?php echo e(!empty($meeting) ? $meeting->in_person_group_max_student : old('in_person_group_max_student')); ?>" class="form-control" placeholder="Masukan angka"/>
                            <div class="invalid-feedback"></div>
                        </div>
                        ...
                        <div class="col-12 col-lg-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="in_person_group_amount" value="<?php echo e(!empty($meeting) ? $meeting->in_person_group_amount : old('in_person_group_amount')); ?>" class="form-control" placeholder="Masukan angka"/>
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
                    </div>
...
<?php $__env->startPush('scripts_bottom'); ?>
    ...
    <script type="text/javascript">
        ...
        var successDeleteTime = '<?php echo e(('Waktu berhasil dihapus')); ?>';
        var errorDeleteTime = '<?php echo e(('Kesalahan dalam menghapus waktu')); ?>';
        var successSavedTime = '<?php echo e(('Waktu berhasil disimpan')); ?>';
        var errorSavingTime = '<?php echo e(('Kesalahan saat menyimpan waktu')); ?>';
        var noteToTimeMustGreater = '<?php echo e(('Waktu akhir harus lebih besar dari waktu mulai.')); ?>';
        var requestSuccess = '<?php echo e(('Permintaan berhasil dilakukan!')); ?>';
        var requestFailed = '<?php echo e(('Permintaan gagal')); ?>';
        var saveMeetingSuccessLang = '<?php echo e(('Operasi berhasil dilakukan.')); ?>';
        var meetingTypeLang = '<?php echo e(('Jenis pertemuan')); ?>';
        var inPersonLang = '<?php echo e(('Secara tatap muka')); ?>';
        var onlineLang = '<?php echo e(('Daring')); ?>';
        var bothLang = '<?php echo e(('Keduanya')); ?>';
        var descriptionLng = '<?php echo e(('Deskripsi')); ?>';
        var saveTimeDescriptionPlaceholder = '<?php echo e(('Deskripsi (Optional)')); ?>';
...
<?php echo $__env->make(getTemplate() .'.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\simpelnakes\resources\views/web/default/panel/meeting/settings.blade.php ENDPATH**/ ?>