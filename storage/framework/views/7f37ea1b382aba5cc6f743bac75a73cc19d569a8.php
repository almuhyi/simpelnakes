    ...
    <div class="d-flex align-items-center justify-content-between" role="tab" id="session_<?php echo e($session->id); ?>">
        <div class="d-flex align-items-center" href="#collapseSession<?php echo e($session->id); ?>" aria-controls="collapseSession<?php echo e($session->id); ?>" data-parent="#<?php echo e($accordionParent); ?>" role="button" data-toggle="collapse" aria-expanded="true">
            <?php if($session->date > time()): ?>
                <a href="<?php echo e($session->addToCalendarLink()); ?>" target="_blank" class="mr-15 d-flex" data-toggle="tooltip" data-placement="top" title="Tambahkan ke Kalender">
        ...
        <div class="panel-collapse">
            ...
            <?php if(!empty($user) and $hasBought): ?>
                <div class="d-flex align-items-center mt-20">
                    <label class="mb-0 mr-10 cursor-pointer font-weight-500" for="sessionReadToggle<?php echo e($session->id); ?>">Saya lulus pelajaran ini</label>
            ...
            <div class="d-flex align-items-center justify-content-between mt-20">
                <div class="d-flex align-items-center">
                    <div class="d-flex align-items-center text-gray text-center font-14 mr-20">
                        ...
                        <span class="line-height-1"><?php echo e(convertMinutesToHourAndMinute($session->duration)); ?> Jam</span>
                    </div>
                ...
                <div class="">
                    <?php if($session->isFinished()): ?>
                        <button type="button" class="course-content-btns btn btn-sm btn-gray disabled flex-grow-1 disabled session-finished-toast">Selesai</button>
                    <?php elseif(empty($user)): ?>
                        <button type="button" class="course-content-btns btn btn-sm btn-gray disabled flex-grow-1 disabled not-login-toast">Pergi ke pelatihan</button>
                    <?php elseif($hasBought): ?>
                        <?php if(!empty($checkSequenceContent) and $sequenceContentHasError): ?>
                            ...
                            >Pergi ke pelatihan</button>
                        <?php else: ?>
                            <a href="<?php echo e($course->getLearningPageUrl()); ?>?type=session&item=<?php echo e($session->id); ?>" target="_blank" class="course-content-btns btn btn-sm btn-primary flex-grow-1">Pergi ke pelatihan</a>
                        <?php endif; ?>
                    <?php else: ?>
                        <button type="button" class="course-content-btns btn btn-sm btn-gray flex-grow-1 disabled not-access-toast">Pergi ke pelatihan</button>
                    <?php endif; ?>
                </div>
            </div>
        </div>
...
<?php /**PATH C:\laragon\www\simpelnakes\resources\views/web/default/course/tabs/contents/sessions.blade.php ENDPATH**/ ?>