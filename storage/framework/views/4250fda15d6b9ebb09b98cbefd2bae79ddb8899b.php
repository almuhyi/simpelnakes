<div class="row">
    <div class="col-5">
        <div class="form-group">
            <label class="input-label" for="mobile">Negara:</label>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="col-7">
        <div class="form-group">
            <label class="input-label" for="mobile">No Hp <?php echo e(!empty($optional) ? "(". ('Opsional') .")" : ''); ?>:</label>
...
<?php /**PATH C:\laragon\www\simpelnakes\resources\views/web/default/auth/register_includes/mobile_field.blade.php ENDPATH**/ ?>