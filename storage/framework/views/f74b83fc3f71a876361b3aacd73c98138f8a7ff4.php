        ...
        <div class="section-body">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <select name="status" data-plugin-selectTwo class="form-control populate">
                                        ...
                                        <option value="replied" <?php if(request()->get('status') == 'replied'): ?> selected <?php endif; ?>>Menunggu jawaban</option>
                                        <option value="supporter_replied" <?php if(request()->get('status') == 'supporter_replied'): ?> selected <?php endif; ?>>Dijawab</option>
            ...
            <section class="card">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center" width="50">
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_supports_reply')): ?>
                                            <a href="/admin/supports/<?php echo e($support->id); ?>/conversation" class="btn-transparent btn-sm text-primary" data-toggle="tooltip" data-placement="top" title="Balas">
                ...
                <div class="card-footer text-center">
                    <?php echo e($supports->appends(request()->input())->links('vendor.pagination.bootstrap-4')); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\simpelnakes\resources\views/admin/supports/lists.blade.php ENDPATH**/ ?>