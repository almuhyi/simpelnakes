<div class="rounded-lg shadow-sm mt-35 p-20 course-teacher-card d-flex align-items-center flex-column">
    ...
    <?php if(!empty($webinarPartnerTeacher)): ?>
        <span class="user-select-none px-15 py-10 bg-gray200 off-label text-gray text-white font-12 rounded-sm ml-auto">Diundang</span>
    <?php endif; ?>

    <div class="teacher-avatar mt-5">
        <img src="<?php echo e(asset($courseTeacher->getAvatar(100))); ?>" class="img-cover" alt="<?php echo e($courseTeacher->full_name); ?>">
    ...
    <div class="mt-25 d-flex flex-row align-items-center justify-content-center w-100">
        <a href="<?php echo e(url($courseTeacher->getProfileUrl())); ?>" target="_blank" class="btn btn-sm btn-primary <?php echo e($hasMeeting ? 'teacher-btn-action' : 'btn-block'); ?>">Profil</a>

        <?php if($hasMeeting): ?>
            <a href="<?php echo e(url($courseTeacher->getProfileUrl())); ?>" class="btn btn-sm btn-primary teacher-btn-action ml-15">Ajukan pertemuan</a>
        <?php endif; ?>
    </div>
</div>
<?php /**PATH C:\laragon\www\simpelnakes\resources\views/web/default/course/sidebar_instructor_profile.blade.php ENDPATH**/ ?>