...
<div class="d-none" id="webinarSessionModal">
    ...
    <form action="<?php echo e(url('/admin/sessions/store')); ?>" method="post" class="session-form">
...
<?php /**PATH C:\laragon\www\simpelnakes\resources\views/admin/webinars/modals/session.blade.php ENDPATH**/ ?>