                                    ...
                                    <?php if(!empty($items)): ?>
                                        <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="/admin/additional_page/navbar_links/<?php echo e($key); ?>/edit" class="btn-sm" data-toggle="tooltip" data-placement="top" title="Edit">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\simpelnakes\resources\views/admin/additional_pages/navbar_links.blade.php ENDPATH**/ ?>