            ...
            <div class="course-noticeboards noticeboard-<?php echo e($noticeboard->color); ?> p-15 mt-15 rounded-sm w-100">
                <div class="d-flex align-items-center">
                    ...
                    <div class="ml-10">
                        ...
                        <span class="d-block font-12"><?php echo e($noticeboard->creator->full_name); ?> Pada <?php echo e(dateTimeFormat($noticeboard->created_at,'j M Y')); ?></span>
                    </div>
                </div>
...
<?php /**PATH C:\laragon\www\simpelnakes\resources\views/web/default/course/learningPage/components/noticeboards.blade.php ENDPATH**/ ?>