                                        ...
                                        <td class="align-middle text-right font-weight-normal">
                                            <div class="btn-group dropdown table-actions table-actions-lg table-actions-lg">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a href="/panel/quizzes/<?php echo e($quiz->id); ?>/start" class="webinar-actions d-block mt-10">Mulai</a>
                                                    <a href="<?php echo e($quiz->webinar->getUrl()); ?>" target="_blank" class="webinar-actions d-block mt-10">Halaman pelatihan</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
...
<?php echo $__env->make(getTemplate() .'.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\simpelnakes\resources\views/web/default/panel/quizzes/opens.blade.php ENDPATH**/ ?>