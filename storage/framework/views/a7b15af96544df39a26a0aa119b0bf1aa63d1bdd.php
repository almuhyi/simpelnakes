                        ...
                        <div class="col-12 col-md-4 col-lg-2">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="userRole" name="role">
                                    ...
                                    <option value="student" <?php if(request()->get('role') == 'student'): ?> selected <?php endif; ?> >Peserta</option>
                                    <option value="teacher" <?php if(request()->get('role') == 'teacher'): ?> selected <?php endif; ?> >Instruktur</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="webinar" class="form-control select2" data-placeholder="Semua">
                                ...
                                <?php $__currentLoopData = $webinars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $webinar): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($webinar->id); ?>" <?php if(request()->get('webinar') == $webinar->id): ?> selected <?php endif; ?>><?php echo e($webinar->title); ?> <?php if(in_array($webinar->id,$purchasedWebinarsIds)): ?>  <?php endif; ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-4 col-lg-2">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="status" name="status">
                                <option value="all">Semua</option>
                                <option value="open" <?php if(request()->get('status') == 'open'): ?> selected <?php endif; ?> >Dibuka</option>
                                <option value="close" <?php if(request()->get('status') == 'close'): ?> selected <?php endif; ?> >Ditutup</option>
                                <option value="replied" <?php if(request()->get('status') == 'replied'): ?> selected <?php endif; ?> >Dijawab</option>
                            </select>
                        </div>
                    </div>
                                                ...
                                                <div class="user-inline-avatar d-flex align-items-center">
                                                    ...
                                                    <div class="ml-10">
                                                        ...
                                                        <span class="mt-1 font-12 text-gray d-block">
                                                            <?php echo e((!empty($support->webinar) and $support->webinar->teacher_id != $authUser->id) ? 'Instruktur' : ( ($support->user->isUser()) ? 'Peserta' : 'Staf')); ?>
                        ...
                        <div class="col-12 col-lg-6 border-left border-gray300">
                            <div class="conversation-box p-15 d-flex align-items-center justify-content-between">
                                <div>
                                    ...
                                    <span class="font-12 mt-1 text-gray d-block">Dibuat: <?php echo e(dateTimeFormat($support->created_at,'j M Y | H:i')); ?></span>

                                    <?php if(!empty($selectSupport->webinar)): ?>
                                        <span class="font-12 text-gray d-block mt-5">Pelatihan: <?php echo e($selectSupport->webinar->title); ?></span>
                                    <?php endif; ?>
                                </div>

                                <?php if($selectSupport->status != 'close'): ?>
                                    <a href="/panel/support/<?php echo e($selectSupport->id); ?>/close" class="btn btn-primary btn-sm">Tutup percakapan</a>
                                <?php endif; ?>
                            </div>
                                            ...
                                            <div class="d-flex align-items-center justify-content-between pb-20 border-bottom border-gray300">
                                                <div class="user-inline-avatar d-flex align-items-center">
                                                    ...
                                                    <div class="ml-10">
                                                        ...
                                                        <span class="mt-1 font-12 text-gray d-block"><?php echo e((!empty($conversations->supporter)) ? 'Staf' : $conversations->sender->role_name); ?></span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="d-flex flex-column align-items-end">
                                                    ...
                                                    <?php if(!empty($conversations->attach)): ?>
                                                        <a href="<?php echo e(url($conversations->attach)); ?>" target="_blank" class="font-12 mt-10 text-danger"><i data-feather="paperclip" height="14"></i> Lampiran</a>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
...
<?php echo $__env->make(getTemplate() .'.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\simpelnakes\resources\views/web/default/panel/support/conversations.blade.php ENDPATH**/ ?>