            ...
            <div class="row h-100 align-items-center justify-content-center text-center">
                <div class="col-12 col-md-9 col-lg-7">
                    ...
                    <div class="mt-20 font-16 font-weight-500 text-white">
                        <span>Materi <?php echo e($textLesson->order); ?>/<?php echo e(count($course->textLessons)); ?> </span> | <span>Waktu belajar: <?php echo e($textLesson->study_time); ?> Menit</span>
                    </div>

                    <div class="mt-20 font-16 font-weight-500 text-white">
                        <span>Pelatihan: <a href="<?php echo e(url($course->getUrl())); ?>" class="font-16 font-weight-500 text-white text-decoration-underline"><?php echo e($course->title); ?></a></span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-12 col-lg-8">
                <div class="post-show mt-30">
                    ...
                    <div class="post-img pb-30">
                        <img src="<?php echo e(asset($textLesson->image)); ?>" alt="<?php echo e($textLesson->title); ?>"/>
                    </div>
                ...
                <div class="mt-30 row align-items-center">
                    <div class="col-12 col-md-5">
                        <?php if(auth()->check()): ?>
                            <div class="d-flex align-items-center justify-content-between">
                                <label class="cursor-pointer font-weight-500" for="readLessonSwitch">Saya lulus pelajaran ini</label>
                    ...
                    <div class="col-12 col-md-7 text-right">
                        <?php if(!empty($course->textLessons) and count($course->textLessons)): ?>
                            <a href="<?php echo e(url((!empty($previousLesson)) ? $course->getUrl() .'/lessons/'. $previousLesson->id .'/read' : '#')); ?>" class="btn btn-sm <?php echo e((!empty($previousLesson)) ? 'btn-primary' : 'btn-gray disabled'); ?>">Materi sebelumnya</a>

                            <?php if(!empty($nextLesson)): ?>
                                <a href="<?php echo e(url((!$nextLesson->not_purchased) ? $course->getUrl() .'/lessons/'. $nextLesson->id .'/read' : '#')); ?>" class="btn btn-sm <?php echo e((!$nextLesson->not_purchased) ? 'btn-primary' : 'btn-gray disabled'); ?> <?php echo e(($nextLesson->not_purchased) ? 'js-not-purchased' : ''); ?>">Materi selanjutnya</a>
                            <?php endif; ?>
                        <?php endif; ?>
                    </div>
                </div>
            ...
            <div class="col-12 col-lg-4">
                ...
                <div class="rounded-lg shadow-sm mt-35 p-20 course-teacher-card d-flex align-items-center flex-column">
                    <div class="teacher-avatar mt-5">
                        <img src="<?php echo e(asset($course->teacher->getAvatar(100))); ?>" class="img-cover" alt="<?php echo e($course->teacher->full_name); ?>">
                    </div>
                    <h3 class="mt-10 font-20 font-weight-bold text-secondary"><?php echo e($course->teacher->full_name); ?></h3>
                    <span class="mt-5 font-weight-500 text-gray">Desainer produk</span>
                    ...
                    <div class="user-reward-badges d-flex flex-wrap align-items-center mt-20">
                        <?php $__currentLoopData = $course->teacher->getBadges(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $userBadge): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="mr-15 mt-10" data-toggle="tooltip" data-placement="bottom" data-html="true" title="<?php echo (!empty($userBadge->badge_id) ? nl2br($userBadge->badge->description) : nl2br($userBadge->description)); ?>">
                                <img src="<?php echo e(url(!empty($userBadge->badge_id) ? $userBadge->badge->image : $userBadge->image)); ?>" width="32" height="32" alt="<?php echo e(!empty($userBadge->badge_id) ? $userBadge->badge->title : $userBadge->title); ?>">
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>

                    <div class="mt-25 d-flex flex-row align-items-center justify-content-center w-100">
                        <a href="<?php echo e($course->teacher->getProfileUrl()); ?>" target="_blank" class="btn btn-sm btn-primary teacher-btn-action">Profil</a>

                        <?php if(!empty($course->teacher->hasMeeting())): ?>
                            <a href="<?php echo e(url($course->teacher->getProfileUrl())); ?>" class="btn btn-sm btn-primary teacher-btn-action ml-15">Ajukan pertemuan</a>
                        <?php else: ?>
                            <button type="button" class="btn btn-sm btn-primary disabled teacher-btn-action ml-15">Ajukan pertemuan</button>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <?php if(!empty($textLesson->attachments) and count($textLesson->attachments)): ?>
                    <div class="shadow-sm rounded-lg bg-white px-15 px-md-25 py-20 mt-30">
                        <h3 class="category-filter-title font-16 font-weight-bold text-dark-blue">Lampiran file</h3>
                        ...
                        <ul class="p-0 m-0 pt-10">
                            <?php $__currentLoopData = $textLesson->attachments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attachment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="mt-10 p-10 rounded bg-info-light font-14 font-weight-500 text-dark-blue d-flex align-items-center justify-content-between text-ellipsis">
                                    ...
                                    <a href="<?php echo e(url($course->getLearningPageUrl())); ?>?type=file&item=<?php echo e($attachment->file->id); ?>" target="_blank">
                ...
                <?php if(!empty($course->textLessons) and count($course->textLessons)): ?>
                    <div class="shadow-sm rounded-lg bg-white px-15 px-md-25 py-20 mt-30">
                        <h3 class="category-filter-title font-16 font-weight-bold text-dark-blue">Sesi materi</h3>
                        ...
                        <div class="p-0 m-0 pt-10">
                            <?php $__currentLoopData = $course->textLessons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lesson): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a href="<?php echo e(url($course->getUrl())); ?>/lessons/<?php echo e($lesson->id); ?>/read"
...
<?php $__env->startPush('scripts_bottom'); ?>
    ...
    <script src="<?php echo e(asset('')); ?>assets/default/js/parts/text_lesson.min.js"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make(getTemplate().'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\simpelnakes\resources\views/web/default/course/text_lesson.blade.php ENDPATH**/ ?>