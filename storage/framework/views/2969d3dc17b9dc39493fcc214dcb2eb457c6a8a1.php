                    ...
                    <table class="table table-striped font-14" id="datatable-details">
                        ...
                        <tr>
                            ...
                            <th class="text-center">
                                Penyerahan Pertama</th>
                            <th class="text-center">
                                Penyerahan terakhir</th>
                            ...
                            <tr>
                                ...
                                <td class="align-middle text-right">
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_webinar_assignments_conversations')): ?>
                                        <a href="/admin/assignments/<?php echo e($assignment->id); ?>/history/<?php echo e($history->id); ?>/conversations" class="btn-transparent text-primary" data-toggle="tooltip" data-placement="top" title="Percakapan">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\simpelnakes\resources\views/admin/webinars/assignments/students.blade.php ENDPATH**/ ?>