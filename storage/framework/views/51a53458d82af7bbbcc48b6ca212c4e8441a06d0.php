...
<nav class="navbar navbar-expand-lg main-navbar">
    ...
    <ul class="navbar-nav navbar-right">
                    ...
                    <div class="dropdown-list-icons mb-0" height="150px">
                            <a href="javascript::void(0)" class="dropdown-item">
                                ...
                                <div class="dropdown-item-desc">
                                    Version 1
                                   <div class="time text-primary">All rights reserved</div>
                                </div>
                            </a>
                    </div>
                </div>
            ...
            <li class="dropdown dropdown-list-toggle">
                ...
                <div class="dropdown-menu dropdown-list dropdown-menu-right">
                    <div class="dropdown-header">Notifikasi
                        <div class="float-right">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_notifications_markAllRead')): ?>
                                <a href="<?php echo e(url('/admin/notifications/mark_all_read')); ?>">
                    ...
                    <div class="dropdown-footer text-center">
                        <a href="<?php echo e(url('/admin/notifications')); ?>">Lihat semua <i class="fas fa-chevron-right"></i></a>
                    </div>
                </div>
            </li>
        <?php endif; ?>
        ...
        <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                <img alt="image" src="<?php echo e(asset($authUser->getAvatar())); ?>" class="rounded-circle mr-1">
                <div class="d-sm-none d-lg-inline-block"><?php echo e($authUser->full_name); ?></div>
            </a>
            <div class="dropdown-menu dropdown-menu-right">

                 <a href="<?php echo e(url('/')); ?>" class="dropdown-item has-icon">
                    <i class="fas fa-globe"></i> Lihat tampilan web
                </a>

                <a href="<?php echo e(url('')); ?>/admin/users/<?php echo e($authUser->id); ?>/edit" class="dropdown-item has-icon">
                    <i class="fas fa-cog"></i> Ubah kata sandi
                </a>

                <div class="dropdown-divider"></div>
                <a href="<?php echo e(url('/admin/logout')); ?>" class="dropdown-item has-icon text-danger">
...
<?php /**PATH C:\laragon\www\simpelnakes\resources\views/admin/includes/navbar.blade.php ENDPATH**/ ?>