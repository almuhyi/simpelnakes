        ...
        <div class="xs-w-100 d-flex align-items-center justify-content-between ">
            ...
            <?php if(!empty($authUser)): ?>
                ...
                <div class="dropdown">
                    <a href="#!" class="navbar-user d-flex align-items-center ml-50 dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <img src="<?php echo e(asset($authUser->getAvatar())); ?>" class="rounded-circle" alt="<?php echo e($authUser->full_name); ?>">
                    ...
                    <div class="dropdown-menu user-profile-dropdown" aria-labelledby="dropdownMenuButton">
                        ...
                        <a class="dropdown-item" href="<?php echo e(url($authUser->isAdmin() ? '/admin' : '/panel')); ?>">
                            <img src="<?php echo e(asset('')); ?>assets/default/img/icons/sidebar/dashboard.svg" width="25" alt="nav-icon">
                            <span class="font-14 text-dark-blue">Panel</span>
                        </a>
                        <?php if($authUser->isTeacher() or $authUser->isOrganization()): ?>
                            <a class="dropdown-item" href="<?php echo e(url($authUser->getProfileUrl())); ?>">
                                <img src="<?php echo e(asset('')); ?>assets/default/img/icons/profile.svg" width="25" alt="nav-icon">
                                <span class="font-14 text-dark-blue">Profil</span>
                            </a>
                        <?php endif; ?>
                        <a class="dropdown-item" href="<?php echo e(url('/logout')); ?>">
                            <img src="<?php echo e(asset('')); ?>assets/default/img/icons/sidebar/logout.svg" width="25" alt="nav-icon">
            ...
            <?php else: ?>
                <div class="d-flex align-items-center ml-md-50">
                    <a href="<?php echo e(url('/login')); ?>" class="py-5 px-10 mr-10 text-dark-blue font-14">Masuk</a>
                    <a href="<?php echo e(url('/register')); ?>" class="py-5 px-10 text-dark-blue font-14">Registrasi</a>
                </div>
            <?php endif; ?>
        </div>
    </div>
...
<?php $__env->startPush('scripts_bottom'); ?>
    <link href="<?php echo e(asset('')); ?>assets/default/vendors/flagstrap/css/flags.css" rel="stylesheet">
    <script src="<?php echo e(asset('')); ?>assets/default/vendors/flagstrap/js/jquery.flagstrap.min.js"></script>
    <script src="<?php echo e(asset('')); ?>assets/default/js/parts/top_nav_flags.min.js"></script>
<?php $__env->stopPush(); ?>
<?php /**PATH C:\laragon\www\simpelnakes\resources\views/web/default/includes/top_nav.blade.php ENDPATH**/ ?>