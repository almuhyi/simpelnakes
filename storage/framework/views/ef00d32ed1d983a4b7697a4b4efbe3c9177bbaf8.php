                        ...
                        <?php if(!empty($post->author)): ?>
                            <span class="mt-10 mt-md-20 font-16 font-weight-500 text-white">Dibuat oleh
                                <?php if($post->author->isTeacher()): ?>
                                    <a href="<?php echo e(url($post->author->getProfileUrl())); ?>" target="_blank" class="text-white"><?php echo e($post->author->full_name); ?></a>
                                <?php elseif(!empty($post->author->full_name)): ?>
                                    <span class="text-white"><?php echo e($post->author->full_name); ?></span>
                                <?php endif; ?>
                                Pada

                                <?php echo e(dateTimeFormat($post->created_at, 'j M Y')); ?>

                            </span>
                        <?php endif; ?>
                    </div>
                    <span class="mt-10 font-16 font-weight-500 text-white">Kategori</span>
                    <a href="<?php echo e(url($post->category->getUrl())); ?>" class="text-white text-decoration-underline"><?php echo e($post->category->title); ?></a>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="col-12 col-lg-4">
                <?php if(!empty($post->author) and !empty($post->author->full_name)): ?>
                    <div class="rounded-lg shadow-sm mt-35 p-20 course-teacher-card d-flex align-items-center flex-column">
                        <div class="teacher-avatar mt-5">
                            <img src="<?php echo e(asset($post->author->getAvatar(100))); ?>" class="img-cover" alt="">
                        </div>
                        ...
                        <div class="mt-25 d-flex align-items-center  w-100">
                            <a href="<?php echo e(url('')); ?>/blog?author=<?php echo e($post->author->id); ?>" class="btn btn-sm btn-primary btn-block px-15">Penulis</a>
                        </div>
                    </div>
                <?php endif; ?>
                ...
                <div class="p-20 mt-30 rounded-sm shadow-lg border border-gray300">
                    ...
                    <div class="pt-15">
                        <?php $__currentLoopData = $blogCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blogCategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e(url($blogCategory->getUrl())); ?>" class="font-14 text-dark-blue d-block mt-15"><?php echo e($blogCategory->title); ?></a>
                ...
                <div class="p-20 mt-30 rounded-sm shadow-lg border border-gray300">
                    ...
                    <div class="pt-15">
                        ...
                        <?php $__currentLoopData = $popularPosts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $popularPost): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="popular-post d-flex align-items-start mt-20">
                                <div class="popular-post-image rounded">
                                    <img src="<?php echo e(asset($popularPost->image)); ?>" class="img-cover rounded" alt="<?php echo e($popularPost->title); ?>">
                                </div>
                                <div class="popular-post-content d-flex flex-column ml-10">
                                    <a href="<?php echo e(url($popularPost->getUrl())); ?>">
                        ...
                        <a href="<?php echo e(url('/blog')); ?>" class="btn btn-sm btn-primary btn-block mt-30">Lihat semua post</a>
                    </div>
                </div>
...
<?php $__env->startPush('scripts_bottom'); ?>
    <script>
        ...
        var saveLang = '<?php echo e(('Menyimpan')); ?>';
        var reportLang = '<?php echo e(('Laporkan')); ?>';
        var reportSuccessLang = '<?php echo e(('Laporan sukses')); ?>';
        var messageToReviewerLang = '<?php echo e(('Pesan untuk pengulas')); ?>';
    </script>

    <script src="<?php echo e(asset('')); ?>assets/default/js/parts/comment.min.js"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make(getTemplate().'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\simpelnakes\resources\views/web/default/blog/show.blade.php ENDPATH**/ ?>