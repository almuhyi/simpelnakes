        ...
        <div class="d-flex align-items-center" href="#collapseTextLessons<?php echo e($textLesson->id); ?>" aria-controls="collapseTextLessons<?php echo e($textLesson->id); ?>" data-parent="#<?php echo e($accordionParent); ?>" role="button" data-toggle="collapse" aria-expanded="true">
            ...
            <?php if($textLesson->accessibility == 'paid'): ?>
                <?php if(!empty($user) and $hasBought): ?>
                    <a href="<?php echo e($course->getLearningPageUrl()); ?>?type=text_lesson&item=<?php echo e($textLesson->id); ?>" target="_blank" class="mr-15" data-toggle="tooltip" data-placement="top" title="Baca">
            ...
            <?php else: ?>
                ...
                <?php else: ?>
                    <a href="<?php echo e($course->getUrl()); ?>/lessons/<?php echo e($textLesson->id); ?>/read" target="_blank" class="mr-15" data-toggle="tooltip" data-placement="top" title="Baca">
                        <span class="chapter-icon chapter-content-icon">
                            <i data-feather="file-text" width="20" height="20" class="text-gray"></i>
                        </span>
                    </a>
        ...
        <div class="panel-collapse">
            ...
            <?php if(!empty($user) and $hasBought): ?>
                <div class="d-flex align-items-center mt-20">
                    <label class="mb-0 mr-10 cursor-pointer font-weight-500" for="textLessonReadToggle<?php echo e($textLesson->id); ?>">Saya lulus pelajaran ini</label>
            ...
            <div class="d-flex align-items-center justify-content-between mt-20">
                ...
                <div class="d-flex align-items-center">
                    <div class="d-flex align-items-center text-gray text-center font-14 mr-20">
                        ...
                        <span class="line-height-1"><?php echo e($textLesson->study_time); ?> Menit</span>
                    </div>

                    <div class="d-flex align-items-center text-gray text-center font-14 mr-20">
                        <i data-feather="paperclip" width="18" height="18" class="text-gray mr-5"></i>
                        <span class="line-height-1">Lampiran file: <?php echo e($textLesson->attachments_count); ?></span>
                    </div>
                </div>
...
<?php /**PATH C:\laragon\www\simpelnakes\resources\views/web/default/course/tabs/contents/text_lessons.blade.php ENDPATH**/ ?>