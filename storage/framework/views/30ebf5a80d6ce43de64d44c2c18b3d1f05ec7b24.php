    ...
    <div class="course-reviews-box row align-items-center">
        <div class="col-3 text-center">
            ...
            <div class="text-center">
                ...
                <div class="mt-15"><?php echo e($course->reviews->pluck('creator_id')->count()); ?> Ulasan</div>
            </div>
        </div>
        ...
        <div class="col-9">
            <div class="d-flex align-items-center">
                ...
                <span class="ml-15 font-14 text-gray text-left">Kualitas isi materi (<?php echo e($course->reviews->count() > 0 ? round($course->reviews->avg('content_quality'), 1) : 0); ?>)</span>
            </div>
            ...
            <div class="mt-25 d-flex align-items-center">
                ...
                <span class="ml-15 font-14 text-gray text-left">Keterampilan instruktur (<?php echo e($course->reviews->count() > 0 ? round($course->reviews->avg('instructor_skills'), 1) : 0); ?>)</span>
            </div>
            ...
            <div class="mt-25 d-flex align-items-center">
                ...
                <span class="ml-15 font-14 text-gray text-left">Nilai pembelian (<?php echo e($course->reviews->count() > 0 ? round($course->reviews->avg('purchase_worth'), 1) : 0); ?>)</span>
            </div>
            ...
            <div class="mt-25 d-flex align-items-center">
                ...
                <span class="ml-15 font-14 text-gray text-left">Kualitas dukungan (<?php echo e($course->reviews->count() > 0 ? round($course->reviews->avg('support_quality'), 1) : 0); ?>)</span>
            </div>
...
<section class="mt-40">
    <h2 class="section-title after-line">Ulasan (<?php echo e($course->reviews->pluck('creator_id')->count()); ?>)</h2>
                    ...
                    <div class="d-flex align-items-center justify-content-between">
                        <div class="user-inline-avatar d-flex align-items-center mt-10">
                            <div class="avatar bg-gray200">
                                <img src="<?php echo e(asset($review->creator->getAvatar())); ?>" class="img-cover" alt="">
                            </div>
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="btn-group dropdown table-actions">
                                ...
                                <div class="dropdown-menu">
                                    <a href="<?php echo e(url('/reviews/store-reply-comment')); ?>" class="webinar-actions d-block text-hover-primary reply-comment">Balas</a>

                                    <?php if(!empty($user) and $user->id == $review->creator_id): ?>
                                        <a href="<?php echo e(url('')); ?>/reviews/<?php echo e($review->id); ?>/delete" class="webinar-actions d-block mt-10 text-hover-primary">Hapus</a>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <?php $__currentLoopData = $review->comments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="shadow-lg rounded-sm border px-20 py-15 mt-30">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="user-inline-avatar d-flex align-items-center mt-10">
                                        <div class="avatar bg-gray200">
                                            <img src="<?php echo e(asset($comment->user->getAvatar())); ?>" class="img-cover" alt="<?php echo e($comment->user->full_name); ?>">
                                        </div>
                                        <div class="d-flex flex-column ml-5">
...
<?php /**PATH C:\laragon\www\simpelnakes\resources\views/web/default/course/tabs/reviews.blade.php ENDPATH**/ ?>