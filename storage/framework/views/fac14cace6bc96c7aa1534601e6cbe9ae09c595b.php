...
<div class="d-none" id="webinarPrerequisitesModal">
    ...
    <div class="js-prerequisites-form" data-action="<?php echo e(url('/admin/prerequisites/store')); ?>" >
        ...
        <div class="form-group mt-15">
            ...
            <select id="prerequisitesSelect" name="prerequisite_id" class="js-ajax-prerequisite_id form-control prerequisites-select" data-webinar-id="<?php echo e(!empty($webinar) ? $webinar->id : ''); ?>" data-placeholder="Cari prasyarat">
...
<?php /**PATH C:\laragon\www\simpelnakes\resources\views/admin/webinars/modals/prerequisites.blade.php ENDPATH**/ ?>