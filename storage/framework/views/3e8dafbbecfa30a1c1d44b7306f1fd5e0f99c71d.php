...
unset($__errorArgs, $__bag); ?>" placeholder="Deskripsi"><?php echo (!empty($post) and !empty($post->translate($locale))) ? $post->translate($locale)->description : old('description'); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" placeholder="Isi konten"><?php echo (!empty($post) and !empty($post->translate($locale))) ? $post->translate($locale)->content : old('content'); ?></textarea>
...
<?php echo $__env->make('web.default.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\simpelnakes\resources\views/web/default/panel/blog/posts/create.blade.php ENDPATH**/ ?>