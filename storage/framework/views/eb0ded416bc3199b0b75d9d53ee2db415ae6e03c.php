                                    ...
                                    <div class="chat-details">
                                        ...
                                        <div class="chat-time">
                                            ...
                                            <?php if(!empty($conversations->attach)): ?>
                                                <a href="<?php echo e(url($conversations->attach)); ?>" target="_blank" class="text-success"><i class="fa fa-paperclip"></i> Buka lampiran</a>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-4 text-right mt-4">
                                        ...
                                        <?php if($support->status != 'close'): ?>
                                            <a href="/admin/supports/<?php echo e($support->id); ?>/close" class="btn btn-danger ml-1">Tutup percakapan</a>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </form>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\simpelnakes\resources\views/admin/supports/conversation.blade.php ENDPATH**/ ?>