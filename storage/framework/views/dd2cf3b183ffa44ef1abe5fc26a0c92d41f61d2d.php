...
<?php if(!empty($advertisingModalSettings)): ?>
    <div class="d-none" id="advertisingModalSettings">
        ...
        <div class="d-flex align-items-center justify-content-center">
            <img src="<?php echo e(asset($advertisingModalSettings['image'] ?? '')); ?>" class="img-fluid rounded-lg" alt="<?php echo e($advertisingModalSettings['title'] ?? 'ads'); ?>">
        </div>
        ...
        <div class="row align-items-center mt-20">
            <?php if(!empty($advertisingModalSettings['button1']) and !empty($advertisingModalSettings['button1']['link']) and !empty($advertisingModalSettings['button1']['title'])): ?>
                <div class="col-6">
                    <a href="<?php echo e(url($advertisingModalSettings['button1']['link'])); ?>" class="btn btn-primary btn-sm btn-block"><?php echo e($advertisingModalSettings['button1']['title']); ?></a>
                </div>
            <?php endif; ?>
            ...
            <?php if(!empty($advertisingModalSettings['button2']) and !empty($advertisingModalSettings['button2']['link']) and !empty($advertisingModalSettings['button2']['title'])): ?>
                <div class="col-6">
                    <a href="<?php echo e(url($advertisingModalSettings['button2']['link'])); ?>" class="btn btn-outline-primary btn-sm btn-block"><?php echo e($advertisingModalSettings['button2']['title']); ?></a>
                </div>
            <?php endif; ?>
        </div>
    </div>
<?php endif; ?>
<?php /**PATH C:\laragon\www\simpelnakes\resources\views/web/default/includes/advertise_modal/index.blade.php ENDPATH**/ ?>