<li data-id="<?php echo e(!empty($prerequisite) ? $prerequisite->id :''); ?>" class="accordion-row bg-white rounded-sm panel-shadow mt-20 py-15 py-lg-30 px-10 px-lg-20">
    <div class="d-flex align-items-center justify-content-between " role="tab" id="prerequisite_<?php echo e(!empty($prerequisite) ? $prerequisite->id :'record'); ?>">
        <div class="font-weight-bold text-dark-blue" href="#collapsePrerequisite<?php echo e(!empty($prerequisite) ? $prerequisite->id :'record'); ?>" aria-controls="collapsePrerequisite<?php echo e(!empty($prerequisite) ? $prerequisite->id :'record'); ?>" data-parent="#prerequisitesAccordion" role="button" data-toggle="collapse" aria-expanded="true">
            <span><?php echo e((!empty($prerequisite) and !empty($prerequisite->prerequisiteWebinar)) ? $prerequisite->prerequisiteWebinar->title .' - '. $prerequisite->prerequisiteWebinar->teacher->full_name : 'Tambahkan prasyarat baru'); ?></span>
        </div>
            ...
            <?php if(!empty($prerequisite)): ?>
                <div class="btn-group dropdown table-actions mr-15">
                    ...
                    <div class="dropdown-menu">
                        <a href="/panel/prerequisites/<?php echo e($prerequisite->id); ?>/delete" class="delete-action btn btn-sm btn-transparent">Hapus</a>
                    </div>
                </div>
            <?php endif; ?>
        ...
        <div class="panel-collapse text-gray">
            <div class="prerequisite-form" data-action="/panel/prerequisites/<?php echo e(!empty($prerequisite) ? $prerequisite->id . '/update' : 'store'); ?>">
                ...
                <div class="row">
                    <div class="col-12 col-lg-12">
                        <div class="form-group mt-15">
                            ...
                            <select name="ajax[<?php echo e(!empty($prerequisite) ? $prerequisite->id : 'new'); ?>][prerequisite_id]" class="js-ajax-prerequisite_id <?php if(empty($prerequisite)): ?> form-control <?php endif; ?> prerequisites-select2" data-webinar-id="<?php echo e(!empty($webinar) ? $webinar->id : ''); ?>" data-placeholder="Cari prasyarat">
                        ...
                        <div class="form-group mt-30 d-flex align-items-center justify-content-between mb-0">
                            <label class="cursor-pointer input-label" for="requiredPrerequisitesSwitch<?php echo e(!empty($prerequisite) ? $prerequisite->id : 'record'); ?>">Diperlukan</label>
                        ...
                        <div class="mt-5">
                            <p class="font-12 text-gray">- Untuk prasyarat yang diperlukan (wajib), peserta harus lulus sebelum membeli kursus Anda.</p>
                        </div>
                ...
                <div class="mt-30 d-flex align-items-center">
                    <button type="button" class="js-save-prerequisite btn btn-sm btn-primary">Simpan</button>
...
<?php /**PATH C:\laragon\www\simpelnakes\resources\views/web/default/panel/webinar/create_includes/accordions/prerequisites.blade.php ENDPATH**/ ?>