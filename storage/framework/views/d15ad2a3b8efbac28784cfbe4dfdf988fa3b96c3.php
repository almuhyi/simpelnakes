...
<a href="<?php echo e(url($instructor->getProfileUrl())); ?>" class="">
    <div class="position-relative d-flex flex-wrap instructor-finder-card border border-gray300 rounded-sm py-25 mt-20">
        ...
        <div class="col-12 col-md-8 d-flex">
            <div class="instructor-avatar rounded-circle">
                <img src="<?php echo e(asset($instructor->getAvatar(70))); ?>" class="img-cover rounded-circle" alt="<?php echo e($instructor->full_name); ?>">
            </div>
        ...
        <div class="col-12 col-md-4 mt-10 mt-md-0 pt-10 pt-md-0 instructor-finder-card-right-side position-relative">
            <?php if(!empty($discount)): ?>
                <span class="off-badge badge badge-danger">Diskon <?php echo e($discount); ?>%</span>
            <?php endif; ?>
            ...
            <div class="d-flex align-items-start">
                <?php if(!empty($instructor->meeting)): ?>
                    <?php if(!empty($price)): ?>
                        ...
                        <span class="font-14 font-weight-500 text-gray mt-5">/ Jam</span>
                    <?php else: ?>
                        <span class="font-weight-bold text-primary font-14">Gratis</span>
                    <?php endif; ?>
                <?php else: ?>
                    <span class="font-weight-bold text-danger font-12">Belum tersedia untuk pertemuan</span>
                <?php endif; ?>
            </div>
            ...
            <div class="d-flex align-items-center mt-20">
                ...
                <span class="font-14 font-weight-500 text-dark-blue ml-10"><?php echo e($instructor->getTotalHoursTutoring()); ?> Jam bimbingan</span>
            </div>
            ...
            <div class="d-flex align-items-center flex-wrap mt-15">
                <?php $__currentLoopData = $instructor->getBadges(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $badge): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="mr-15 mt-10 instructor-badge rounded-circle" data-toggle="tooltip" data-placement="bottom" data-html="true" title="<?php echo (!empty($badge->badge_id) ? nl2br($badge->badge->description) : nl2br($badge->description)); ?>">
                        <img src="<?php echo e(asset(!empty($badge->badge_id) ? $badge->badge->image : $badge->image)); ?>" class="img-cover rounded-circle" alt="<?php echo e(!empty($badge->badge_id) ? $badge->badge->title : $badge->title); ?>">
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>
...
<?php /**PATH C:\laragon\www\simpelnakes\resources\views/web/default/instructorFinder/components/instructor_card.blade.php ENDPATH**/ ?>