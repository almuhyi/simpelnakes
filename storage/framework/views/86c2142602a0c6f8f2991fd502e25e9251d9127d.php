        ...
        <div class="section-body">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="post" action="/admin/notifications/<?php echo e(!empty($notification) ? $notification->id .'/update' : 'store'); ?>" class="form-horizontal form-bordered mt-4">
...
unset($__errorArgs, $__bag); ?>">
                                        ...
                                        <?php $__currentLoopData = \App\Models\Notification::$notificationsType; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($type); ?>" <?php if(!empty($notification) and $notification->type == $type): ?> selected <?php endif; ?>><?php echo e($type); ?></option>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\simpelnakes\resources\views/admin/notifications/send.blade.php ENDPATH**/ ?>