...
<div class="mt-20 p-20 rounded-sm shadow-lg border border-gray300 filters-container">
    <div class="">
        <h3 class="category-filter-title font-20 font-weight-bold text-dark-blue">Pilihan</h3>

        <div class="pt-10">

            <div class="d-flex align-items-center justify-content-between mt-20">
                <label class="cursor-pointer" for="filterOptionsOnlyAvailableProducts">Hanya produk yang tersedia</label>
                <div class="custom-control custom-checkbox">
            ...
            <div class="d-flex align-items-center justify-content-between mt-20">
                <label class="cursor-pointer" for="filterOptionsWithPoint">Produk dengan poin</label>
                <div class="custom-control custom-checkbox">
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\simpelnakes\resources\views/web/default/products/includes/right_filters.blade.php ENDPATH**/ ?>