...
<?php $__env->startSection('content'); ?>
    <section class="cart-banner position-relative text-center">
        ...
        <span class="payment-hint font-20 text-white d-block"><?php echo e(addCurrencyToPrice($total) . ' ' . 'untuk' . ' ' .$count . ' ' . 'item'); ?></span>
    </section>
        ...
        <form action="/payments/payment-request" method="post" class=" mt-25">
            ...
            <div class="d-flex align-items-center justify-content-between mt-45">
                <span class="font-16 font-weight-500 text-gray">
                    Jumlah total <?php echo e(addCurrencyToPrice($total)); ?></span>
...
<?php echo $__env->make(getTemplate().'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\simpelnakes\resources\views/web/default/cart/payment.blade.php ENDPATH**/ ?>