            ...
            <div class="d-flex align-items-center justify-content-between mt-20">
                ...
                <div class="d-flex align-items-center">
                    <div class="d-flex align-items-center text-gray text-center font-14 mr-20">
                        ...
                        <span class="line-height-1">Nilai Min: <?php echo e($assignment->pass_grade); ?></span>
                    </div>
                </div>
                ...
                <div class="">
                    ...
                    <?php elseif(!empty($user) and $hasBought): ?>
                        <a href="<?php echo e(url($course->getLearningPageUrl())); ?>?type=assignment&item=<?php echo e($assignment->id); ?>" target="_blank" class="course-content-btns btn btn-sm btn-primary">
                            Baca
                        </a>
                    <?php else: ?>
...
<?php /**PATH C:\laragon\www\simpelnakes\resources\views/web/default/course/tabs/contents/assignment.blade.php ENDPATH**/ ?>