<?php $__env->startSection('content'); ?>
    <div class="container">
        <section class="mt-40">
            ...
            <p class="text-gray font-14 mt-5"><?php echo e($quiz->title); ?> | Oleh <span class="font-weight-bold"><?php echo e($quiz->creator->full_name); ?></span></p>
                    ...
                    <div class="no-result default-no-result mt-50 d-flex align-items-center justify-content-center flex-column">
                        ...
                        <div class="d-flex align-items-center flex-column mt-30 text-center">
                            ...
                            <p class="mt-5 text-center">
                                Anda lulus ujian dengan nilai <?php echo $quizResult->user_grade.'/'.$quizQuestions->sum('grade'); ?></p>
                            ...
                            <div class=" mt-25">
                                <a href="/panel/quizzes/my-results" class="btn btn-sm btn-primary">Lihat hasil</a>

                                <?php if($quiz->certificate): ?>
                                    <a href="/panel/quizzes/results/<?php echo e($quizResult->id); ?>/showCertificate" class="btn btn-sm btn-primary">Download sertifikat</a>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
                ...
                <?php case (\App\Models\QuizzesResult::$failed): ?>
                    <div class="no-result status-failed mt-50 d-flex align-items-center justify-content-center flex-column">
                        ...
                        <div class="d-flex align-items-center flex-column mt-30 text-center">
                            ...
                            <p class="mt-5 text-center">Nilai lulus kuis adalah <?php echo $quiz->pass_mark .'/'. $quizQuestions->sum('grade'); ?> tetapi nilai anda adalah <?php echo $quizResult->user_grade; ?></p>
                            <?php if($canTryAgain): ?>
                                <p>Jangan khawatir, Anda bisa mencoba lagi.</p>
                            <?php endif; ?>
                            <div class=" mt-25">
                                <?php if($canTryAgain): ?>
                                    <a href="/panel/quizzes/<?php echo e($quiz->id); ?>/start" class="btn btn-sm btn-primary">Coba lagi</a>
                                <?php endif; ?>
                                <a href="/panel/quizzes/my-results" class="btn btn-sm btn-primary">Lihat hasil</a>
                            </div>
                        </div>
...
<?php echo $__env->make(getTemplate().'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\simpelnakes\resources\views/web/default/panel/quizzes/status.blade.php ENDPATH**/ ?>