                        ...
                        <div class="d-flex align-items-center justify-content-between" role="tab" id="chapter_<?php echo e($chapter->id); ?>">
                            ...
                            <div class="d-flex align-items-center">
                                <span class="mr-15 font-14 text-gray">
                                    <?php echo e($chapter->getTopicsCount(true)); ?> Bagian
                                    <?php echo e(!empty($chapter->getDuration()) ? ' - ' . convertMinutesToHourAndMinute($chapter->getDuration()) .' '. ('Jam') : ''); ?>
...
<?php /**PATH C:\laragon\www\simpelnakes\resources\views/web/default/course/tabs/contents/chapter.blade.php ENDPATH**/ ?>