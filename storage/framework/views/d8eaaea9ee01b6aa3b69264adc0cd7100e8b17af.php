        ...
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item active">
                    <a href="/admin/store/categories"><?php echo e(trans('admin/main.categories')); ?></a>
                </div>
        ...
        <div class="section-body">
            ...
            <div class="row">
                <div class="col-12 col-md-6 col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            <form action="/admin/store/categories/<?php echo e(!empty($category) ? $category->id.'/update' : 'store'); ?>"
                                  method="Post">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\simpelnakes\resources\views/admin/store/categories/create.blade.php ENDPATH**/ ?>