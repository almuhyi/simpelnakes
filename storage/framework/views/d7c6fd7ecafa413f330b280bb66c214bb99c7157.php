        ...
        <div class="section-body">
            ...
            <div class="card">
                                ...
                                <tr>
                                    ...
                                    <td width="100">
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_contacts_reply')): ?>
                                            <a href="/admin/contacts/<?php echo e($contact->id); ?>/reply" class="btn-transparent btn-sm text-primary" data-toggle="tooltip" data-placement="top" title="Balas">
                ...
                <div class="card-footer text-center">
                    <?php echo e($contacts->appends(request()->input())->links('vendor.pagination.bootstrap-4')); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\simpelnakes\resources\views/admin/contacts/lists.blade.php ENDPATH**/ ?>