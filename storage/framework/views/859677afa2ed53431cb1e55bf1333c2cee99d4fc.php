                                        ...
                                        <td class="align-middle text-right">
                                            ...
                                            <div class="btn-group dropdown table-actions">
                                                ...
                                                <div class="dropdown-menu">
                                                    <button type="button" data-comment-id="<?php echo e($comment->id); ?>" class="js-edit-comment btn-transparent">Edit</button>
                                                    <a href="/panel/webinars/comments/<?php echo e($comment->id); ?>/delete" class="delete-action btn-transparent d-block mt-10">Hapus</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
...
<?php $__env->startPush('scripts_bottom'); ?>
    ...
    <script>
        ...
        var editCommentLang = '<?php echo e(('Edit komentar')); ?>';
        var saveLang = '<?php echo e(('Simpan')); ?>';
        var closeLang = '<?php echo e(('Tutup')); ?>';
        var failedLang = '<?php echo e(('Gagal')); ?>';
    </script>
    <script src="/assets/default/js/panel/comments.min.js"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make(getTemplate() .'.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\simpelnakes\resources\views/web/default/panel/webinar/my_comments.blade.php ENDPATH**/ ?>