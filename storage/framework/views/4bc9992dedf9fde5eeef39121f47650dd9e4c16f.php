...
<?php else: ?>
                        ...
                        <div class="col-12 col-lg-12">
                            ...
                            <div class="form-group js-file-path-input <?php echo e((!empty($file) and $file->storage == 's3') ? 'd-none' : ''); ?>">
                                <div class="local-input input-group">
                                    ...
                                    <input type="text" name="ajax[<?php echo e(!empty($file) ? $file->id : 'new'); ?>][file_path]" id="file_path<?php echo e(!empty($file) ? $file->id : 'record'); ?>" value="<?php echo e((!empty($file)) ? $file->file : ''); ?>" class="js-ajax-file_path form-control" placeholder="unggah file dari komputer Anda"/>
                                    <div class="invalid-feedback"></div>
                                </div>
                            </div>
                            ...
                            <div class="js-online_viewer-input form-group mt-20">
                                <div class="d-flex align-items-center justify-content-between">
                                    <label class="cursor-pointer input-label" for="online_viewerSwitch<?php echo e(!empty($file) ? $file->id : '_record'); ?>">Penampil daring</label>
                            ...
                            <?php if(getFeaturesSettings('sequence_content_status')): ?>
                                <div class="form-group mt-20">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <label class="cursor-pointer input-label" for="SequenceContentSwitch<?php echo e(!empty($file) ? $file->id : '_record'); ?>">Lanjutan</label>
                                        <div class="custom-control custom-switch">
                                ...
                                <div class="js-sequence-content-inputs pl-5 <?php echo e((!empty($file) and ($file->check_previous_parts or !empty($file->access_after_day))) ? '' : 'd-none'); ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="ajax[<?php echo e(!empty($file) ? $file->id : 'new'); ?>][access_after_day]" value="<?php echo e((!empty($file)) ? $file->access_after_day : ''); ?>" class="js-ajax-access_after_day form-control" placeholder="misalnya '10' untuk mengizinkan peserta mengakses bagian ini setelah 10 hari."/>
                                        <div class="invalid-feedback"></div>
                                    </div>
                                </div>
                            <?php endif; ?>
    ...
    <?php $__env->stopPush(); ?>
<?php endif; ?>
<?php /**PATH C:\laragon\www\simpelnakes\resources\views/web/default/panel/webinar/create_includes/accordions/file.blade.php ENDPATH**/ ?>