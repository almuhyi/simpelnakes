        ...
        <div class="section-body">
                ...
                <div class="card-body">
                    <form method="get" class="mb-0">
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label class="input-label">Tanggal awal</label>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <select name="status" class="form-control populate">
                                        ...
                                        <option value="pending" <?php if(request()->get('status') == 'pending'): ?> selected <?php endif; ?>>Disembunyikan</option>
                                    </select>
                                </div>
                            </div>
            ...
            <section class="card">
                        ...
                        <?php $__currentLoopData = $reviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td class="">
                                    ...
                                    <?php elseif(!empty($review->bundle_id)): ?>
                                        <span class="">Paket pelatihan</span>
                                    <?php endif; ?>
                                </td>
                                ...
                                <td class="">
                                    <?php if($review->status == 'active'): ?>
                                        <b class="f-w-b text-success">Dipublish</b>
                                    <?php else: ?>
                                        <b class="f-w-b text-warning">Disembunyikan</b>
                                    <?php endif; ?>
                                </td>
                                <td class="" width="50">
                ...
                <div class="card-footer text-center">
                    <?php echo e($reviews->appends(request()->input())->links('vendor.pagination.bootstrap-4')); ?>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="contactMessageLabel">Detail</h5>
                ...
                <div class="modal-body">
                    <div class="d-flex align-items-center justify-content-between border-bottom py-2">
                        <span class="font-weight-bold">Kualitas materi:</span>
                        <span class="js-content_quality"></span>
                    </div>

                    <div class="d-flex align-items-center justify-content-between border-bottom py-2">
                        <span class="font-weight-bold">Skill instruktur:</span>
                        <span class="js-instructor_skills"></span>
                    </div>

                    <div class="d-flex align-items-center justify-content-between border-bottom py-2">
                        <span class="font-weight-bold">Nilai pembelian:</span>
                        <span class="js-purchase_worth"></span>
                    </div>

                    <div class="d-flex align-items-center justify-content-between border-bottom py-2">
                        <span class="font-weight-bold">Kualitas bantuan:</span>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\simpelnakes\resources\views/admin/reviews/lists.blade.php ENDPATH**/ ?>